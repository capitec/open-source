import{a as m}from"./chunk.FS4G6H4L.js";import{d as h}from"./chunk.DYIGYEUP.js";import{a as s,b as n}from"./chunk.CHYIO324.js";import{b as d,c as i,e as c}from"./chunk.CDDA2I3H.js";import{j as r,l as a,o as l}from"./chunk.2ZZQBHAA.js";a();l();var o=class extends h{connectedCallback(){super.connectedCallback(),this.tabIndex=this.disabled?-1:0,this.addEventListener("click",this._click)}focus(){this.shadowRoot.getElementById("content").focus()}_click(e){if(this.disabled)return e.stopImmediatePropagation();this._toggleChecked(e)}_keyDown(e){if(this.disabled)return e.stopImmediatePropagation();let t=(e.code||"").toUpperCase();if(t==="SPACE"||t==="ENTER")return this._toggleChecked(e),e.preventDefault()}_toggleChecked(e){let t=this.checked;this.checked=!t,this.dispatchEvent(new CustomEvent("value-change",{detail:{old:t,new:this.checked}})),e.stopPropagation()}static get styles(){return[super.styles,d`
        :host {
          outline: none;
        }
      ...
      `]}render(){return i`
      <div
        class=${m({container:!0,indeterminate:this.indeterminate,checked:this.checked,disabled:this.disabled})}>
...
//# sourceMappingURL=chunk.5DD47JWF.js.map
