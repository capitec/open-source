import{a as m}from"./chunk.FS4G6H4L.js";import{c as h}from"./chunk.63F4QTY7.js";import{a as s,b as e}from"./chunk.CHYIO324.js";import{b as c,c as n,e as t}from"./chunk.CDDA2I3H.js";import{j as i,l as d,o as l}from"./chunk.2ZZQBHAA.js";d();l();var o=class extends h{focus(){this.shadowRoot.getElementById("content").focus()}_click(r){if(this.disabled)return r.stopImmediatePropagation();this._toggleChecked()}_keyDown(r){if(this.disabled)return r.stopImmediatePropagation();let a=(r.code||"").toUpperCase();if(a==="SPACE"||a==="ENTER")return this._toggleChecked(),r.preventDefault()}_toggleChecked(){let r=this.checked;this.checked=!r,this.dispatchEvent(new CustomEvent("value-change",{detail:{old:r,new:this.checked}}))}static get styles(){return[super.styles,c`
      ...
      `]}render(){return n`
      <div
        class=${m({container:!0,checked:this.checked,disabled:this.disabled})}>
...
//# sourceMappingURL=chunk.A4JNVIOR.js.map
