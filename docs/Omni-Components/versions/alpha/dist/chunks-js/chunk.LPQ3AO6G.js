import{a as h}from"./chunk.FS4G6H4L.js";import{c as b}from"./chunk.63F4QTY7.js";import{a as d,b as r}from"./chunk.CHYIO324.js";import{b as s,c as n,e as a}from"./chunk.CDDA2I3H.js";import{j as t,l as c,o as l}from"./chunk.2ZZQBHAA.js";c();l();var o=class extends b{focus(){this.shadowRoot.getElementById("track").focus()}_click(i){if(this.disabled)return i.stopImmediatePropagation();this._switchChecked()}_switchChecked(){let i=this.checked;this.checked=!i,this.dispatchEvent(new CustomEvent("value-change",{detail:{old:i,new:this.checked},bubbles:!0}))}_keyDown(i){if(this.disabled)return i.stopImmediatePropagation();let e=(i.code||"").toUpperCase();if(e==="SPACE"||e==="ENTER"||e==="NUMPADENTER")return this._switchChecked(),i.preventDefault()}static get styles(){return[super.styles,s`
        /* CONTAINER STYLES */
        .container {
          display: flex;
          align-items: center;
...
//# sourceMappingURL=chunk.LPQ3AO6G.js.map
