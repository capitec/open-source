import{a as h}from"./chunk.XMM72FEY.js";import{h as s}from"./chunk.ZO5UBYOG.js";import{a as m,b as n}from"./chunk.CHYIO324.js";import{a as d,b as i,d as c}from"./chunk.3GEUDTAZ.js";import{j as r,l as a,o as l}from"./chunk.2ZZQBHAA.js";a();l();var o=class extends s{connectedCallback(){super.connectedCallback(),this.tabIndex=this.disabled?-1:0,this.addEventListener("click",this._click)}focus(){this.shadowRoot.getElementById("content").focus()}_click(e){if(this.disabled)return e.stopImmediatePropagation();this._toggleChecked(e)}_keyDown(e){if(this.disabled)return e.stopImmediatePropagation();let t=(e.code||"").toUpperCase();if(t==="SPACE"||t==="ENTER")return this._toggleChecked(e),e.preventDefault()}_toggleChecked(e){let t=this.checked;this.checked=!t,this.dispatchEvent(new CustomEvent("value-change",{detail:{old:t,new:this.checked}})),e.stopPropagation()}static get styles(){return[super.styles,d`
        :host {
          outline: none;
        }
    ...
    `}};r([n({type:String,reflect:!0})],o.prototype,"label",2),r([n({type:Object,reflect:!0})],o.prototype,"data",2),r([n({type:String,reflect:!0})],o.prototype,"hint",2),r([n({type:String,reflect:!0})],o.prototype,"error",2),r([n({type:Boolean,reflect:!0})],o.prototype,"checked",2),r([n({type:Boolean,reflect:!0})],o.prototype,"disabled",2),r([n({type:Boolean,reflect:!0})],o.prototype,"indeterminate",2),o=r([m("omni-check")],o);export{o as a};
//# sourceMappingURL=chunk.O33TLQ2P.js.map
