import{a as h}from"./chunk.F27L6OQP.js";import{h as m}from"./chunk.7YN44Q4N.js";import{a as s,b as n}from"./chunk.CHYIO324.js";import{a as c,b as a,d as t}from"./chunk.CIM3NS6G.js";import{j as e,l as d,o as l}from"./chunk.2ZZQBHAA.js";d();l();var r=class extends m{focus(){var o,i;(i=(o=this.shadowRoot)==null?void 0:o.getElementById("content"))==null||i.focus()}_click(o){if(this.disabled)return o.stopImmediatePropagation();this._toggleChecked()}_keyDown(o){if(this.disabled)return o.stopImmediatePropagation();let i=(o.code||"").toUpperCase();if(i==="SPACE"||i==="ENTER")return this._toggleChecked(),o.preventDefault()}_toggleChecked(){let o=this.checked;this.checked=!o,this.dispatchEvent(new CustomEvent("value-change",{detail:{old:o,new:this.checked}}))}static get styles(){return[super.styles,c`
        :host {
