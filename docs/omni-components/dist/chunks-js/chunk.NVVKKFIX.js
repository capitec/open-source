import{a as u,b as g}from"./chunk.MRDDZJ5F.js";import{a as i}from"./chunk.DUTPH62F.js";import{h}from"./chunk.E2CUUU4Y.js";import{a as p,b as n,d as c}from"./chunk.Y6UVSDXK.js";import{a as s,d as t,g as d,i as f}from"./chunk.UDCULUBW.js";import{j as r,m as l,p as m}from"./chunk.BF43NN75.js";l();m();var o=class extends h{constructor(){super(...arguments);this.headerLabel=""}static show(e){if(e.parent||(e.parent=document.createElement("div"),document.body.appendChild(e.parent)),typeof e.parent=="string"&&(e.parent=document.getElementById(e.parent),!e.parent))return;let a=u();return f(t`        
      ...
      `]}render(){return t`
		...
		`}_renderFooter(){return this.noFooter?d:t`
            ...
            </div>`}};r([n({type:String,attribute:"header-label",reflect:!0})],o.prototype,"headerLabel",2),r([n({type:String,attribute:"header-align",reflect:!0})],o.prototype,"headerAlign",2),r([n({type:Boolean,reflect:!0})],o.prototype,"hide",2),r([n({type:Boolean,attribute:"no-header",reflect:!0})],o.prototype,"noHeader",2),r([n({type:Boolean,attribute:"no-footer",reflect:!0})],o.prototype,"noFooter",2),r([n({type:Boolean,attribute:"no-fullscreen",reflect:!0})],o.prototype,"noFullscreen",2),r([c("dialog")],o.prototype,"dialog",2),o=r([p("omni-modal")],o);export{o as a};
//# sourceMappingURL=chunk.NVVKKFIX.js.map
