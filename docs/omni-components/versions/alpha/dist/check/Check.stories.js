import{a as g}from"../chunks-js/chunk.IRJIQSYL.js";import{a as l}from"../chunks-js/chunk.G3QHRCKP.js";import{b as k}from"../chunks-js/chunk.MHLMY33S.js";import{l as p,w as f}from"../chunks-js/chunk.R2G2NSIY.js";import"../chunks-js/chunk.P3AVSJ2D.js";import"../chunks-js/chunk.H2SV3XAM.js";import"../chunks-js/chunk.U46MGZPC.js";import"../chunks-js/chunk.ZPV4YWBP.js";import{a as h}from"../chunks-js/chunk.PJH7M65U.js";import{c as i,d}from"../chunks-js/chunk.N6OKW4B2.js";import{d as c}from"../chunks-js/chunk.W54IKPJD.js";import"../chunks-js/chunk.HGGE2J65.js";import"../chunks-js/chunk.MZ2O7RKR.js";import"../chunks-js/chunk.2TH7MEM4.js";import"../chunks-js/chunk.B6SUKNHE.js";import"../chunks-js/chunk.2HYOR3YM.js";import"../chunks-js/chunk.CWNKFZ3E.js";import"../chunks-js/chunk.S2K25ADN.js";import{b as r,d as m}from"../chunks-js/chunk.F6MIXR4E.js";import{h as $,m as w,p as C}from"../chunks-js/chunk.BF43NN75.js";w();C();var y=$(g(),1);var N={title:"UI Components/Check",component:"omni-check",argTypes:{indeterminate_icon:{control:"text"},check_icon:{control:"text"}}},P={render:e=>r`
    <omni-check
...
const App = () => <OmniCheck${e.label?` label='${e.label}'`:""}${e.disabled?" disabled":""}/>;`}],description:"Prevent interaction (pointer events).",args:{label:"Disabled",disabled:!0},play:async e=>{var s,b;let a=i(e.canvasElement).getByTestId("test-check"),t=y.fn();a.addEventListener("value-change",t);let n=(s=a.shadowRoot)==null?void 0:s.querySelector(".disabled");await c(n).toBeTruthy();let o=(b=a.shadowRoot)==null?void 0:b.getElementById("content");await k.click(o,{pointerEventsCheck:0}),await d.keyDown(o,{key:" ",code:"Space"}),await c(t).toBeCalledTimes(0)}},Q={render:e=>r`
...
const App = () => <OmniCheck${e.label?` label='${e.label}'`:""}${e.checked?" checked":""}>
                ...
                </OmniCheck>;`}],description:"Set html content to render when the component is in a checked state.",args:{label:"Custom Check Icon",checked:!0,check_icon:f`<svg slot="check_icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 442.79 410.38" version="1.0" width="100%"
                      height="100%">
                      <path style="stroke:#000;stroke-width:19.892;fill:lightgreen"
                        d="m-1747.2-549.3 287.72 333.9c146.6-298.83 326.06-573.74 614.52-834.75-215.89 121.82-453.86 353.14-657.14 639.38l-245.1-138.53z"
                        transform="translate(843.77 509.04) scale(.48018)" />
                    </svg>`},play:async e=>{var o;let t=(o=i(e.canvasElement).getByTestId("test-check").shadowRoot)==null?void 0:o.querySelector("slot[name=check_icon]");await c(t).toBeTruthy();let n=t==null?void 0:t.assignedElements().find(s=>s.tagName.toLowerCase()==="svg");await c(n).toBeTruthy()}},V={render:e=>r`
...
const App = () => <OmniCheck${e.label?` label='${e.label}'`:""}${e.indeterminate?" indeterminate":""}>
		...
		`},play:async e=>{var o;let t=(o=i(e.canvasElement).getByTestId("test-check").shadowRoot)==null?void 0:o.querySelector("slot[name=indeterminate_icon]");await c(t).toBeTruthy();let n=t==null?void 0:t.assignedElements().find(s=>s.tagName.toLowerCase()==="svg");await c(n).toBeTruthy()}};export{W as Checked,Q as Custom_Check_Icon,V as Custom_Indeterminate_Icon,K as Disabled,S as Error_Label,v as Hint,J as Indeterminate,P as Interactive,u as Label,N as default};
