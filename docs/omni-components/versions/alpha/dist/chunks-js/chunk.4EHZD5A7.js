import{a as E}from"./chunk.QQ4KC6E2.js";import{a as y}from"./chunk.YTU7KEBB.js";import{a as b,b as s,c as g,d as a}from"./chunk.4PFNWG2J.js";import{a as f,d as r}from"./chunk.63YMDT6M.js";import{j as o,m as c,p as v}from"./chunk.BF43NN75.js";c();v();var t=class extends E{constructor(){super();this.type="text";this.showPin=!1;this._boundBeforeInputEventListener=this._beforeInput.bind(this),this._boundOnInputEventListener=this._onInput.bind(this),this._boundOnKeyUpEventListener=this._blurOnEnter.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener("beforeinput",this._boundBeforeInputEventListener,{capture:!0}),this.addEventListener("input",this._boundOnInputEventListener,{capture:!0}),this.addEventListener("keyup",this._boundOnKeyUpEventListener,{capture:!0})}disconnectedCallback(){this.removeEventListener("beforeinput",this._beforeInput.bind(this),!0),this.removeEventListener("input",this._onInput.bind(this),!0),this.removeEventListener("keyup",this._blurOnEnter.bind(this),!0),super.disconnectedCallback()}async firstUpdated(){let e=window.getComputedStyle(this._inputElement);this.isWebkit=e.webkitTextSecurity,this.isWebkit||(this.type="password"),this._sanitiseValue()}updated(e){var i,n,l,d,p,u,h,m;e.has("value")&&(this.value?((n=(i=this.container)==null?void 0:i.classList)==null||n.add("float-label"),(d=(l=this.container)==null?void 0:l.classList)==null||d.remove("no-float-label")):((u=(p=this.container)==null?void 0:p.classList)==null||u.remove("float-label"),(m=(h=this.container)==null?void 0:h.classList)==null||m.add("no-float-label")),this._sanitiseValue())}focus(e){this._inputElement?this._inputElement.focus(e):super.focus(e)}_sanitiseValue(){var e,i,n;this.value?this.maxLength&&this.value.length>this.maxLength&&(this.value=(e=this.value)==null?void 0:e.slice(0,this.maxLength)):this.value="",this.value=(n=(i=this.value)==null?void 0:i.toString())==null?void 0:n.replace(/[^\d]/gi,""),this._inputElement&&(this._inputElement.value=this.value)}_blurOnEnter(e){(e.code==="Enter"||e.keyCode===13)&&e.currentTarget.blur()}_isNumber(e){return/\d/.test(e)}_beforeInput(e){if(this._inputElement&&e.data!==null&&!this._isNumber(e.data)){e.preventDefault();return}}_onInput(){let e=this._inputElement;(e==null?void 0:e.value)&&this.maxLength&&typeof this.maxLength=="number"&&String(e==null?void 0:e.value).length>this.maxLength&&(e.value=String(e==null?void 0:e.value).slice(0,this.maxLength)),this.value=e==null?void 0:e.value}_iconClicked(e){var i,n;if(this.disabled)return e.stopImmediatePropagation();this.showPin?(this.showPin=!1,(i=this._inputElement)==null||i.setAttribute("data-omni-keyboard-mask",""),this.isWebkit||(this.type="password")):(this.showPin=!0,(n=this._inputElement)==null||n.removeAttribute("data-omni-keyboard-mask"),this.isWebkit||(this.type="text")),this.requestUpdate(),e.stopPropagation()}static get styles(){return[super.styles,f`
    ...
    `}};o([g()],t.prototype,"type",2),o([s({type:Boolean,reflect:!0,attribute:"no-native-keyboard"})],t.prototype,"noNativeKeyboard",2),o([s({type:String,reflect:!1})],t.prototype,"value",2),o([s({type:Number,reflect:!0,attribute:"max-length"})],t.prototype,"maxLength",2),o([a("#inputField")],t.prototype,"_inputElement",2),o([a(".container")],t.prototype,"container",2),t=o([b("omni-pin-field")],t);export{t as a};
//# sourceMappingURL=chunk.4EHZD5A7.js.map
