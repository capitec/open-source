import{a as E,b as L}from"./chunk.MYG5FMLT.js";import{a as b}from"./chunk.LB764BBD.js";import{h as v}from"./chunk.PNTHLTQK.js";import{a as u,b as l,d as g}from"./chunk.S2K25ADN.js";import{a as h,b as i,e as m,g as C}from"./chunk.L3RZWW2F.js";import{j as a,m as p,p as f}from"./chunk.BF43NN75.js";p();f();p();f();var n=class extends v{constructor(){super(...arguments);this.type="none"}static get current(){return n.stack||(n.stack=s.create({})),n.stack}static configure(t){let o=n.current;return t&&(t.position&&(o.position=t.position),typeof t.reverse!="undefined"&&(o.reverse=t.reverse)),o}static show(t){let o=n.current;return t.stack||(o.innerHTML=""),o.showToast(t)}_raiseCloseClick(t){this.dispatchEvent(new CustomEvent("close-click",{detail:{}})),t.stopPropagation()}static get styles(){return[super.styles,h`
			:host {
				display: flex;
				flex-direction: row;
      ...
      `]}render(){return i`
            <div class="container">
                    ...
                    <div class="content">
                        ${this.header?i`<label class="header">${this.header}</label>`:m}
                        ${this.detail?i`<label class="detail">${this.detail}</label>`:m} 
                        <slot></slot>
                    </div>
            </div>
		...
		`}iconTemplate(){switch(this.type){case"info":return i`
				...
				`;default:return m}}};a([l({type:String,reflect:!0})],n.prototype,"type",2),a([l({type:String,reflect:!0})],n.prototype,"header",2),a([l({type:String,reflect:!0})],n.prototype,"detail",2),a([l({type:Boolean,reflect:!0})],n.prototype,"closeable",2),n=a([u("omni-toast")],n);var s=class extends v{constructor(){super(...arguments);this.position="bottom";this.toastCloseClickBound=this.closeToast.bind(this)}static create(t){if(t=t!=null?t:{},t.parent||(t.parent=document.createElement("div"),t.parent.style.display="contents",document.body.appendChild(t.parent)),typeof t.parent=="string"&&(t.parent=document.getElementById(t.parent),!t.parent))return;let o=E();return C(i`        
            <omni-toast-stack
                    ${L(o)}
                    id="${b(t.id)}"
        ...
        `,t.parent),o.value}showToast(t){let o=document.createElement("omni-toast");if(o.type=t.type,o.header=t.header,o.detail=t.detail,o.closeable=t.closeable,t.duration&&o.setAttribute(d,t.duration.toString()),t.prefix){let r=document.createElement("omni-render-element");r.slot="prefix",r.renderer=typeof t.prefix=="function"?t.prefix:()=>t.prefix,o.appendChild(r)}if(t.content){let r=document.createElement("omni-render-element");r.renderer=typeof t.content=="function"?t.content:()=>t.content,o.appendChild(r)}if(t.close&&t.closeable){let r=document.createElement("omni-render-element");r.slot="close",r.renderer=typeof t.close=="function"?t.close:()=>t.close,o.appendChild(r)}return this.showInstance(o)}showInstance(t,o){o!=null&&o.duration&&t.setAttribute(d,o.duration.toString()),typeof(o==null?void 0:o.closeable)!="undefined"&&(t.closeable=o.closeable);let{matches:r}=window.matchMedia(y);return r&&document.timeline?this.slideIn(t):this.appendChild(t),t}onSlotChange(){let t="close-click",o="data-toast-loaded",{matches:r}=window.matchMedia(y),c=r&&document.timeline;this.slotElement.assignedElements({flatten:!0}).forEach(async e=>{var x;e.removeEventListener(t,this.toastCloseClickBound),e.addEventListener(t,this.toastCloseClickBound),e.hasAttribute(o)||(e.setAttribute(o,""),e.hasAttribute(d)?c?(await e.animate([{offset:0,opacity:0},{offset:.1,opacity:1},{offset:.9,opacity:1},{offset:1,opacity:0}],{duration:Number((x=e.getAttribute(d))!=null?x:"5000"),easing:"ease"}).finished,e.parentElement&&(e.remove(),this.raiseToastRemove(e))):(await new Promise(w=>{var k;return setTimeout(w,Number((k=e.getAttribute(d))!=null?k:"5000"))}),e.parentElement&&(e.remove(),this.raiseToastRemove(e))):c&&e.animate([{offset:0,opacity:0},{offset:1,opacity:1}],{duration:500,easing:"ease"}))})}async closeToast(t){let o=t.currentTarget,{matches:r}=window.matchMedia(y);if(r&&document.timeline){let c=Number(getComputedStyle(o).getPropertyValue("opacity"));await o.animate([{offset:0,opacity:c},{offset:1,opacity:0}],{duration:200,easing:"ease"}).finished}o.parentElement&&(o.remove(),this.raiseToastRemove(o))}raiseToastRemove(t){this.dispatchEvent(new CustomEvent("toast-remove",{bubbles:!0,composed:!0,cancelable:!1,detail:t})),t==null||t.dispatchEvent(new CustomEvent("toast-stack-remove",{bubbles:!0,composed:!0,cancelable:!1,detail:this}))}async slideIn(t){this.toastContainer||await this.updateComplete;let o=this.toastContainer.offsetHeight;this.appendChild(t);let c=this.toastContainer.offsetHeight-o,e=this.toastContainer.animate([{transform:`translateY(${c}px)`},{transform:"translateY(0)"}],{duration:150,easing:"ease-out"});e.startTime=document.timeline.currentTime}static get styles(){return[h`
			:host {
				position: fixed;
		...
		`}};a([l({type:String,reflect:!0})],s.prototype,"position",2),a([l({type:Boolean,reflect:!0})],s.prototype,"reverse",2),a([g(".toast-box")],s.prototype,"toastContainer",2),a([g("slot")],s.prototype,"slotElement",2),s=a([u("omni-toast-stack")],s);var y="(prefers-reduced-motion: no-preference)",d="data-toast-duration";export{s as a,d as b,n as c};
//# sourceMappingURL=chunk.5LOR7L6U.js.map
