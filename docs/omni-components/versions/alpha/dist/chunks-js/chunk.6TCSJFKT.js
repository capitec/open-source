import{a as T}from"./chunk.LB764BBD.js";import{h as q}from"./chunk.PNTHLTQK.js";import{a as A,c as g}from"./chunk.S2K25ADN.js";import{a as v,b as l,e as p}from"./chunk.L3RZWW2F.js";import{j as b,m,p as f}from"./chunk.BF43NN75.js";m();f();var n=class extends q{connectedCallback(){super.connectedCallback(),this._observer=new MutationObserver(e=>{var r;for(let t of e)t.type==="attributes"&&this.requestUpdate();(r=this._observer)==null||r.observe(this,{attributes:!0,attributeFilter:["header"],subtree:!0})})}disconnectedCallback(){this._observer&&this._observer.disconnect(),super.disconnectedCallback()}selectTab(e){var h,u;if(!e||e.classList.contains("tab-bar"))return;e=e.closest("omni-tab-header");let r=Array.from(this.children),t=r.find(a=>a.id&&a.id===e.for||a===e.data);if(!t||t.hasAttribute(c))return;let i=[...r.filter(a=>a.slot==="header"),...((u=(h=this.shadowRoot)==null?void 0:h.querySelector("slot[name=header]"))==null?void 0:u.children)||[]],s=r.find(a=>a.hasAttribute(o));i.forEach(a=>{a.removeAttribute(d),a.requestUpdate()}),r.forEach(a=>{a.removeAttribute(o)}),t.setAttribute(o,""),e.setAttribute(d,""),e.requestUpdate(),this.dispatchEvent(new CustomEvent("tab-select",{detail:{previous:s,selected:t}})),this.requestUpdate()}static get styles(){return[super.styles,v`
                :host {
                    width:100%;
                    height:100%;
                    overflow: hidden;
...
//# sourceMappingURL=chunk.6TCSJFKT.js.map
