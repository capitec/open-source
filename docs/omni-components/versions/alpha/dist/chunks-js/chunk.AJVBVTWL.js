import{a as c}from"./chunk.QHXD4ILF.js";import{a as f}from"./chunk.55232CD4.js";import{a as u}from"./chunk.RWAXFZOX.js";import{a as h,b as s,c as p,d as m}from"./chunk.S2K25ADN.js";import{a as d,b as o}from"./chunk.L3RZWW2F.js";import{j as n,m as a,p as l}from"./chunk.BF43NN75.js";a();l();var i=class extends f{constructor(){super(...arguments);this.type="number";this.showPin=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("input",this._keyInput.bind(this),{capture:!0}),this.addEventListener("keydown",this._keyDown.bind(this),{capture:!0}),this.addEventListener("keyup",this._blurOnEnter.bind(this),{capture:!0})}async firstUpdated(){let e=window.getComputedStyle(this._inputElement);this.isWebkit=e.webkitTextSecurity,this.isWebkit||(this.type="password"),this.value!==null&&this.value!==void 0&&this.value!==""&&(new RegExp("^[0-9]+$").test(this.value)===!1?this.removeAttribute("value"):this.maxLength&&this.value.length>this.maxLength&&(this.value=String(this.value).slice(0,this.maxLength)))}async attributeChangedCallback(e,r,t){super.attributeChangedCallback(e,r,t),e==="value"&&t!==null&&t!==void 0&&t!==""&&(new RegExp("^[0-9]+$").test(t)===!1?this.removeAttribute("value"):this.maxLength&&t.length>this.maxLength&&(this.value=t==null?void 0:t.slice(0,this.maxLength)))}focus(e){this._inputElement?this._inputElement.focus(e):super.focus(e)}_blurOnEnter(e){(e.code==="Enter"||e.keyCode===13)&&e.currentTarget.blur()}_keyDown(e){if(e.key==="e"||e.key==="-"||e.key==="="||e.key==="+"||e.key==="."){e.preventDefault();return}}_keyInput(){let e=this._inputElement;(e==null?void 0:e.value)&&this.maxLength&&typeof this.maxLength=="number"&&String(e==null?void 0:e.value).length>this.maxLength&&(e.value=String(e==null?void 0:e.value).slice(0,this.maxLength)),this.value=e==null?void 0:e.value}_iconClicked(e){var r,t;if(this.disabled)return e.stopImmediatePropagation();this.showPin?(this.showPin=!1,(r=this._inputElement)==null||r.setAttribute("data-omni-keyboard-mask",""),this.isWebkit||(this.type="password")):(this.showPin=!0,(t=this._inputElement)==null||t.removeAttribute("data-omni-keyboard-mask"),this.isWebkit||(this.type="number")),this.requestUpdate(),e.stopPropagation()}static get styles(){return[super.styles,d`
        .control-box {
          display: flex;
          align-items: center;
...
//# sourceMappingURL=chunk.AJVBVTWL.js.map
