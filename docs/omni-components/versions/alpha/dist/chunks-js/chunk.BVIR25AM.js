import{a as v}from"./chunk.FOPCJEY3.js";import{a as g}from"./chunk.BMTJOHJJ.js";import{a}from"./chunk.PLL7VS6J.js";import{a as d}from"./chunk.R7EUQMUJ.js";import{a as f,b as s,c as l,d as u}from"./chunk.Y6UVSDXK.js";import{a as m,d as n,g as c}from"./chunk.UDCULUBW.js";import{j as o,m as p,p as h}from"./chunk.BF43NN75.js";p();h();var t=class extends g{constructor(){super(...arguments);this.defaultLocale="en-US";this.locale=this.defaultLocale;this.date=this.value&&typeof this.value=="string"?a.fromISO(this.value).setLocale(this.locale):a.local();this._showCalendar=!1;this._bottomOfViewport=!1;this._isMobile=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._inputClick.bind(this)),window.addEventListener("click",this._windowClick.bind(this))}async firstUpdated(){await this._checkForBottomOfScreen(),await this._checkforMobile(),window.addEventListener("resize",this._checkForBottomOfScreen.bind(this)),window.addEventListener("scroll",this._checkForBottomOfScreen.bind(this)),window.addEventListener("resize",this._checkforMobile.bind(this)),window.addEventListener("scroll",this._checkforMobile.bind(this))}shouldUpdate(e){return e.has("value")&&(this.date=a.fromISO(this.value).setLocale(this.locale)),!0}focus(e){this._inputElement?this._inputElement.focus(e):super.focus(e)}async _checkForBottomOfScreen(){(visualViewport==null?void 0:visualViewport.height)-this.getBoundingClientRect().bottom<270?this._bottomOfViewport=!0:this._bottomOfViewport=!1}async _checkforMobile(){(window.matchMedia?window.matchMedia("screen and (min-width: 767px)").matches:window.innerWidth>=767)?this._isMobile=!1:this._isMobile=!0}_inputClick(e){if(this.disabled){e.preventDefault(),e.stopImmediatePropagation();return}let r=this.renderRoot.querySelector("#picker-container"),i=this.renderRoot.querySelector("#picker-dialog");(!e.composedPath()||!(r||i)||!(e.composedPath().includes(r)||e.composedPath().includes(i)))&&this._toggleCalendar()}_windowClick(e){let r=this.renderRoot.querySelector("#picker-dialog"),i=e.composedPath();i&&(!i.includes(this)||this._isMobile&&r&&i.findIndex(b=>b===r)===0)&&this._showCalendar&&this._toggleCalendar()}_toggleCalendar(){if(this._showCalendar){if(this._showCalendar=!1,this._isMobile){let e=this.renderRoot.querySelector("#picker-dialog");e&&e.close()}}else if(this._showCalendar=!0,this._isMobile){let e=this.renderRoot.querySelector("#picker-dialog");e&&(console.log("Showing dialog"),e.showModal())}}_dateSelected(e){this.date=a.fromJSDate(e.detail.date).setLocale(this.locale),this.value=this.date.toISODate(),this.dispatchEvent(new CustomEvent("change",{detail:{date:this.date.toJSDate()}})),this._toggleCalendar()}static get styles(){return[super.styles,m`
...
//# sourceMappingURL=chunk.BVIR25AM.js.map
