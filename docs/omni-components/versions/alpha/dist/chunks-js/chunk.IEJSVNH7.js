import{h as l}from"./chunk.ZTHUBORR.js";import{a as p,b as o}from"./chunk.4PFNWG2J.js";import{a,d as t,g as s}from"./chunk.63YMDT6M.js";import{j as i,m as r,p as d}from"./chunk.BF43NN75.js";r();d();var e=class extends l{constructor(){super();this.buttonAlignment="right";this._boundAnimationEndEventListener=this._animationCompleted.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener("animationend",this._boundAnimationEndEventListener,{capture:!0})}disconnectedCallback(){this.removeEventListener("animationend",this._boundAnimationEndEventListener,!0),super.disconnectedCallback()}_headerClick(n){n.stopPropagation(),!this.disabled&&(this.expanded?this._collapse():this._expand())}_animationCompleted(){this.hasAttribute("expanding")&&(this.removeAttribute("expanding"),this.expanded=!0),this.hasAttribute("collapsing")&&(this.removeAttribute("collapsing"),this.expanded=!1)}_expand(){let{matches:n}=window.matchMedia("(prefers-reduced-motion: no-preference)");if(n){if(this.expanded===!0||this.hasAttribute("expanding"))return;this.removeAttribute("collapsing"),this.setAttribute("expanding","")}else this.expanded=!0;this.dispatchEvent(new CustomEvent("expand"))}_collapse(){let{matches:n}=window.matchMedia("(prefers-reduced-motion: no-preference)");if(n){if(this.expanded===!1||this.hasAttribute("collapsing"))return;this.removeAttribute("expanding"),this.setAttribute("collapsing","")}else this.expanded=!1;this.dispatchEvent(new CustomEvent("collapse"))}static get styles(){return[super.styles,a`
        ...
        ${this.label?t`<omni-label label="${this.label}"></omni-label>`:s}
...
//# sourceMappingURL=chunk.IEJSVNH7.js.map
