import{a as T}from"./chunk.LB764BBD.js";import{h as q}from"./chunk.PNTHLTQK.js";import{a as A,c as g}from"./chunk.S2K25ADN.js";import{a as v,b,e as p}from"./chunk.L3RZWW2F.js";import{j as l,m as f,p as m}from"./chunk.BF43NN75.js";f();m();var d=class extends q{connectedCallback(){super.connectedCallback(),this._observer=new MutationObserver(e=>{var r;for(let t of e)t.type==="attributes"&&this.requestUpdate();(r=this._observer)==null||r.observe(this,{attributes:!0,attributeFilter:["header","active","disabled"],subtree:!0})})}disconnectedCallback(){this._observer&&this._observer.disconnect(),super.disconnectedCallback()}selectTab(e){var h,u;if(!e||e.classList.contains("tab-bar"))return;e=e.closest("omni-tab-header");let r=Array.from(this.children),t;if(e&&(t=r.find(i=>i.id&&i.id===e.for||i===e.data)),!t||t.hasAttribute(c))return;let a=[...r.filter(i=>i.slot==="header"),...((u=(h=this.shadowRoot)==null?void 0:h.querySelector("slot[name=header]"))==null?void 0:u.children)||[]],s=r.find(i=>i.hasAttribute(o));a.forEach(i=>{i.removeAttribute(n),i.requestUpdate()}),r.forEach(i=>{i.removeAttribute(o)}),t.setAttribute(o,""),e.setAttribute(n,""),e.requestUpdate(),this.dispatchEvent(new CustomEvent("tab-select",{detail:{previous:s,selected:t}})),this.requestUpdate()}static get styles(){return[super.styles,v`
                :host {
                    width:100%;
                    height:100%;
                    overflow: hidden;
...
//# sourceMappingURL=chunk.IUTVKY2R.js.map
