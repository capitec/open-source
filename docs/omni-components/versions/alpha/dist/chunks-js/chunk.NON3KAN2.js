import{h as b}from"./chunk.ZTHUBORR.js";import{a as u,b as s}from"./chunk.4PFNWG2J.js";import{a as h,d as o,g as m}from"./chunk.63YMDT6M.js";import{j as r,m as c,p as d}from"./chunk.BF43NN75.js";c();d();var l=class extends b{constructor(){super(...arguments);this._selected=NaN;this.radios=[]}set selected(e){if(this.selected===e)return;if(isFinite(this.selected)){let i=this.radios[this.selected];i&&this._uncheckElement(i)}let t=this.radios[e];t&&this._checkElement(t),this.setAttribute("selected",e.toString()),this._selected=e}get selected(){return this._selected}_uncheckElement(e){e.removeAttribute("aria-checked"),"checked"in e&&(e.checked=!1),e.removeAttribute("checked")}_checkElement(e){e.focus(),e.setAttribute("aria-checked","true"),"checked"in e&&(e.checked=!0),e.setAttribute("checked","true")}connectedCallback(){this.setAttribute("role","radioGroup"),this.addEventListener("click",this._handleClick.bind(this)),super.connectedCallback()}disconnectedCallback(){this.addEventListener("click",this._handleClick.bind(this)),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated(e);let t=this.renderRoot.querySelector("slot");t&&t.addEventListener("slotchange",()=>{this._loadRadios()}),this._loadRadios()}_loadRadios(){var t;let e=this.renderRoot.querySelector("slot");if(this.radios=Array.from((t=e==null?void 0:e.assignedElements())!=null?t:[]),this.radios.length>0){let i=this.radios.find(a=>a.hasAttribute("checked"));i?(i.setAttribute("aria-checked","true"),this._selected=this.radios.indexOf(i)):this._selected=-1}}_handleClick(e){let t=e.target,i=this.radios.indexOf(t);if(i===-1||t.hasAttribute("disabled"))return;let a=this.radios[this.selected],n=this.selected===i;n&&this.allowDeselect&&(i=-1),this.selected=i;let p=this.radios[this.selected];!this.allowDeselect&&!t.hasAttribute("checked")&&this._checkElement(t),n&&this.allowDeselect&&t.hasAttribute("checked")&&this._uncheckElement(t),this.dispatchEvent(new CustomEvent("radio-change",{bubbles:!0,composed:!0,detail:{current:p,previous:a}})),this.requestUpdate()}static get styles(){return[super.styles,h`
    ...
    `}};r([s({type:String,reflect:!0})],l.prototype,"label",2),r([s({type:Boolean,attribute:"allow-deselect",reflect:!0})],l.prototype,"allowDeselect",2),r([s({type:Boolean,reflect:!0})],l.prototype,"horizontal",2),r([s({type:Object,reflect:!0})],l.prototype,"data",2),l=r([u("omni-radio-group")],l);export{l as a};
//# sourceMappingURL=chunk.NON3KAN2.js.map
