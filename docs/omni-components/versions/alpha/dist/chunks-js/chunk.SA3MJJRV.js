import{a as b}from"./chunk.YTU7KEBB.js";import{h as m}from"./chunk.ZTHUBORR.js";import{a as h,b as i}from"./chunk.4PFNWG2J.js";import{a as s,d as t,g as c}from"./chunk.63YMDT6M.js";import{j as n,m as l,p as d}from"./chunk.BF43NN75.js";l();d();var r=class extends m{constructor(){super();this._boundClickEventListener=this._click}connectedCallback(){super.connectedCallback(),this.tabIndex=this.disabled?-1:0,this.addEventListener("click",this._boundClickEventListener)}disconnectedCallback(){this.removeEventListener("click",this._boundClickEventListener),super.disconnectedCallback()}focus(){var o,e;(e=(o=this.shadowRoot)==null?void 0:o.getElementById("content"))==null||e.focus()}_click(o){if(this.disabled)return o.stopImmediatePropagation();this._toggleChecked(o)}_keyDown(o){if(this.disabled)return o.stopImmediatePropagation();let e=(o.code||"").toUpperCase();if(e==="SPACE"||e==="ENTER")return this._toggleChecked(o),o.preventDefault()}_toggleChecked(o){let e=this.checked;this.checked=!e,this.dispatchEvent(new CustomEvent("value-change",{detail:{old:e,new:this.checked}})),o.stopPropagation()}static get styles(){return[super.styles,s`
        :host {
          outline: none;
        }
...
//# sourceMappingURL=chunk.SA3MJJRV.js.map
