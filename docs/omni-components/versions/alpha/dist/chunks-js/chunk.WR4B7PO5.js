import{a as x}from"./chunk.QQ4KC6E2.js";import{a as y}from"./chunk.3F3IIFA7.js";import{a as w}from"./chunk.YTU7KEBB.js";import{a as g,b as n,c as b,d as s}from"./chunk.4PFNWG2J.js";import{a as v,d as o}from"./chunk.63YMDT6M.js";import{j as i,m,p as h}from"./chunk.BF43NN75.js";m();h();var t=class extends x{constructor(){super(...arguments);this.type="password"}connectedCallback(){super.connectedCallback(),this.addEventListener("input",this._keyInput.bind(this),{capture:!0}),this.addEventListener("focus",this._focusInput.bind(this),{capture:!0})}disconnectedCallback(){this.removeEventListener("input",this._keyInput.bind(this),!0),this.removeEventListener("focus",this._focusInput.bind(this),!0),super.disconnectedCallback()}async firstUpdated(){this.value!==null&&this.value!==void 0&&this.maxLength&&(this._inputElement.value=String(this.value).slice(0,this.maxLength))}updated(e){var r,a,l,d,p,c,f,u;e.has("value")&&(this.value?((a=(r=this.container)==null?void 0:r.classList)==null||a.add("float-label"),(d=(l=this.container)==null?void 0:l.classList)==null||d.remove("no-float-label")):((c=(p=this.container)==null?void 0:p.classList)==null||c.remove("float-label"),(u=(f=this.container)==null?void 0:f.classList)==null||u.add("no-float-label")),this._setInputValue())}_setInputValue(){var e;this._inputElement&&(this.maxLength?this._inputElement.value=(e=this.value)==null?void 0:e.slice(0,this.maxLength):this._inputElement.value=this.value)}_focusInput(){let e=this._inputElement;e&&setTimeout(function(){e.selectionStart=e.selectionEnd=1e4},0)}focus(e){this._inputElement?this._inputElement.focus(e):super.focus(e)}_keyInput(){let e=this._inputElement;this.value=e==null?void 0:e.value}_iconClicked(e){if(this.disabled)return e.stopImmediatePropagation();this.type==="password"?this.type="text":this.type="password",e.stopPropagation()}static get styles(){return[super.styles,v`
    ...
    `}};i([b()],t.prototype,"type",2),i([n({type:String,reflect:!1})],t.prototype,"value",2),i([n({type:Boolean,reflect:!0,attribute:"no-native-keyboard"})],t.prototype,"noNativeKeyboard",2),i([n({type:Number,reflect:!0,attribute:"max-length"})],t.prototype,"maxLength",2),i([s("#inputField")],t.prototype,"_inputElement",2),i([s(".container")],t.prototype,"container",2),t=i([g("omni-password-field")],t);export{t as a};
//# sourceMappingURL=chunk.WR4B7PO5.js.map
