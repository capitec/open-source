import{a as x}from"./chunk.ZTJGZLZP.js";import{b as _}from"./chunk.KHZKGRRT.js";import{a as y}from"./chunk.F27L6OQP.js";import{b as f,f as b,g as w}from"./chunk.7YN44Q4N.js";import{a as g,b as m,c as h,d as u}from"./chunk.CHYIO324.js";import{a as v,b as n,d}from"./chunk.CIM3NS6G.js";import{j as s,l as a,o as l}from"./chunk.2ZZQBHAA.js";a();l();a();l();a();l();var p=new WeakMap,T=f(class extends b{render(i){return d}update(i,[r]){var e;let t=r!==this.Y;return t&&this.Y!==void 0&&this.rt(void 0),(t||this.lt!==this.ct)&&(this.Y=r,this.dt=(e=i.options)===null||e===void 0?void 0:e.host,this.rt(this.ct=i.element)),d}rt(i){var r;if(typeof this.Y=="function"){let e=(r=this.dt)!==null&&r!==void 0?r:globalThis,t=p.get(e);t===void 0&&(t=new WeakMap,p.set(e,t)),t.get(this.Y)!==void 0&&this.Y.call(this.dt,void 0),t.set(this.Y,i),i!==void 0&&this.Y.call(this.dt,i)}else this.Y.value=i}get lt(){var i,r,e;return typeof this.Y=="function"?(r=p.get((i=this.dt)!==null&&i!==void 0?i:globalThis))===null||r===void 0?void 0:r.get(this.Y):(e=this.Y)===null||e===void 0?void 0:e.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});var o=class extends _{constructor(){super(...arguments);this.idField="id";this.emptyMessage="No items provided";this._popUp=!1;this._bottomOfViewport=!1;this._isMobile=!1}connectedCallback(){super.connectedCallback(),this._mobileCheck(),this.addEventListener("click",this._inputClick.bind(this)),window.addEventListener("click",this._windowClick.bind(this))}async firstUpdated(){await this._dimensionsCheck(),window.addEventListener("resize",this._dimensionsCheck.bind(this)),window.addEventListener("scroll",this._dimensionsCheck.bind(this))}_inputClick(){this._togglePopup()}_windowClick(e){e.composedPath()&&!e.composedPath().includes(this)&&this._popUp&&this._togglePopup()}_controlClick(){this._togglePopup()}_togglePopup(){this._popUp?this._popUp=!1:this._popUp=!0}async _onItemClick(e){var t;this.value=e,await this.updateComplete,(t=this._selectElement)==null||t.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}async _dimensionsCheck(){await this._bottomCheck(),this._mobileCheck(),await this._itemsMaxHeightChange()}async _bottomCheck(){visualViewport&&(visualViewport.height-this.getBoundingClientRect().bottom<150?this._bottomOfViewport=!0:this._bottomOfViewport=!1)}_mobileCheck(){(window.matchMedia?window.matchMedia("screen and (min-width: 767px)").matches:window.innerWidth>=767)?this._isMobile=!1:this._isMobile=!0}async _itemsMaxHeightChange(e){if(e&&(this._itemsContainer=e),this._itemsContainer&&!this._isMobile&&(await this.updateComplete,visualViewport))if(this._bottomOfViewport){let t=visualViewport.height-this.getBoundingClientRect().height-(visualViewport.height-this.getBoundingClientRect().top)-10+"px";this._itemsContainer.style.maxHeight=`var(--omni-select-items-max-height, ${t})`}else{let t=visualViewport.height-this.getBoundingClientRect().bottom-10+"px";this._itemsContainer.style.maxHeight=`var(--omni-select-items-max-height, ${t})`}}static get styles(){return[super.styles,v`
        ...
        `}renderPicker(){return this._popUp?n`
            <div id="items-container" class="items-container ${this._bottomOfViewport?"bottom":""}">
                ...
                <div ${T(this._itemsMaxHeightChange)} id="items" class="items"> ${w(this._renderOptions(),n`<div>${this.renderLoading()}</div>`)} </div>
            </div>
        ...
        </div>`}renderLoading(){return n`<slot name="loading_indicator"><omni-loading-icon class="loading"></omni-loading-icon></slot>`}};s([u("#select")],o.prototype,"_selectElement",2),s([m({type:Array,reflect:!0})],o.prototype,"items",2),s([m({type:String,reflect:!0,attribute:"display-field"})],o.prototype,"displayField",2),s([m({type:String,reflect:!0,attribute:"id-field"})],o.prototype,"idField",2),s([m({type:String,reflect:!0,attribute:"empty-message"})],o.prototype,"emptyMessage",2),s([m({type:Object,reflect:!1})],o.prototype,"renderItem",2),s([h()],o.prototype,"_popUp",2),s([h()],o.prototype,"_bottomOfViewport",2),s([h()],o.prototype,"_isMobile",2),o=s([g("omni-select")],o);export{o as a};
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
//# sourceMappingURL=chunk.XRGFPLK4.js.map
