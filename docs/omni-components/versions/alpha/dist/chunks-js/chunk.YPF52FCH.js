import{a as f}from"./chunk.I42QKPBU.js";import{a as v}from"./chunk.H65S73QJ.js";import{a as i}from"./chunk.EDMVILOQ.js";import{a}from"./chunk.SDJAFYHN.js";import{a as h,b as m,c as r}from"./chunk.S2K25ADN.js";import{a as c,b as n,d as p}from"./chunk.F6MIXR4E.js";import{j as o,m as l,p as s}from"./chunk.BF43NN75.js";l();s();var t=class extends v{constructor(){super(...arguments);this.defaultLocale="en-US";this.locale=this.defaultLocale;this.date=this.value&&typeof this.value=="string"?i.fromISO(this.value).setLocale(this.locale):i.local();this._showCalendar=!1;this._bottomOfViewport=!1;this._isMobile=!1}connectedCallback(){super.connectedCallback(),this._mobileCheck(),this.addEventListener("click",this._inputClick.bind(this)),window.addEventListener("click",this._windowClick.bind(this))}async firstUpdated(){await this._dimensionsCheck(),window.addEventListener("resize",this._dimensionsCheck.bind(this)),window.addEventListener("scroll",this._dimensionsCheck.bind(this))}shouldUpdate(e){return e.has("value")&&(this.date=i.fromISO(this.value).setLocale(this.locale)),!0}async _dimensionsCheck(){await this._bottomCheck(),this._mobileCheck()}async _bottomCheck(){visualViewport.height-this.getBoundingClientRect().bottom<270?this._bottomOfViewport=!0:this._bottomOfViewport=!1}_mobileCheck(){(window.matchMedia?window.matchMedia("screen and (min-width: 767px)").matches:window.innerWidth>=767)?this._isMobile=!1:this._isMobile=!0}_inputClick(e){let d=this.renderRoot.querySelector("#picker-container");(!e.composedPath()||!d||!e.composedPath().includes(d))&&this._toggleCalendar()}_windowClick(e){e.composedPath()&&!e.composedPath().includes(this)&&this._showCalendar&&(this._showCalendar=!1)}_toggleCalendar(){this._showCalendar?this._showCalendar=!1:this._showCalendar=!0}_dateSelected(e){this.date=i.fromJSDate(e.detail.date),this.value=this.date.toISODate(),this.dispatchEvent(new CustomEvent("change",{detail:{date:this.date.toJSDate()}})),this._toggleCalendar()}static get styles(){return[super.styles,c`
        ...
        `:p}};o([m({type:String,reflect:!0})],t.prototype,"locale",2),o([r()],t.prototype,"date",2),o([r()],t.prototype,"_showCalendar",2),o([r()],t.prototype,"_bottomOfViewport",2),o([r()],t.prototype,"_isMobile",2),t=o([h("omni-date-picker")],t);export{t as a};
//# sourceMappingURL=chunk.YPF52FCH.js.map
