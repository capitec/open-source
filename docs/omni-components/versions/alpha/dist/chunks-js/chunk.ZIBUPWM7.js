import{h as g}from"./chunk.6C4LMRM7.js";import{a as p,b as d,d as h}from"./chunk.S2K25ADN.js";import{a as m,b as i,e as s}from"./chunk.L3RZWW2F.js";import{j as a,m as l,p as c}from"./chunk.BF43NN75.js";l();c();var o=class extends g{constructor(){super(...arguments);this.status="none"}static create(t){var r;let e=document.body.appendChild(document.createElement("omni-alert"));if(t||(t={}),e.status=(r=t.status)!=null?r:"none",e.message=t.message,e.headerAlign=t.headerAlign,e.description=t.description,e.primaryAction=t.primaryAction,e.secondaryAction=t.secondaryAction,e.enableSecondary=t.enableSecondary,e.actionAlign=t.actionAlign,t.id&&(e.id=t.id),t.statusIndicator){let n=document.createElement("omni-render-element");n.slot="status-indicator",n.renderer=typeof t.statusIndicator=="function"?t.statusIndicator:()=>t.statusIndicator,e.appendChild(n)}if(t.header){let n=document.createElement("omni-render-element");n.slot="header",n.renderer=typeof t.header=="function"?t.header:()=>t.header,e.appendChild(n)}if(t.body){let n=document.createElement("omni-render-element");n.renderer=typeof t.body=="function"?t.body:()=>t.body,e.appendChild(n)}if(t.primary){let n=document.createElement("omni-render-element");n.slot="primary",n.renderer=typeof t.primary=="function"?t.primary:()=>t.primary,e.appendChild(n)}if(t.secondary){let n=document.createElement("omni-render-element");n.slot="secondary",n.renderer=typeof t.secondary=="function"?t.secondary:()=>t.secondary,e.appendChild(n)}return e}static show(t){let e=o.create(t);if(t.onClose){let r="auto";e.addEventListener("alert-action-click",n=>{r=n.detail.secondary?"secondary":"primary"}),e.addEventListener("alert-close",()=>{var n;(n=t.onClose)==null||n.apply(e,[r])})}return e.show()}static showAsync(t){return o.create(t).showAsync()}showAsync(){return new Promise((t,e)=>{try{this.show();let r="auto";this.addEventListener("alert-action-click",n=>{r=n.detail.secondary?"secondary":"primary"}),this.addEventListener("alert-close",()=>{t==null||t.apply(this,[r])})}catch(r){e.apply(this,[r])}})}show(){return this.updateComplete.then(()=>{this.modal.hide=!1}),this}hide(){this.updateComplete.then(async()=>{let{matches:t}=window.matchMedia("(prefers-reduced-motion: no-preference)");if(t&&document.timeline){let e=Number(getComputedStyle(this.modal).getPropertyValue("opacity"));await this.modal.animate([{offset:0,opacity:e},{offset:1,opacity:0}],{duration:500,easing:"ease"}).finished}this.modal.hide=!0,this.dispatchEvent(new CustomEvent("alert-close")),this.parentElement&&this.remove()})}onActionClick(t){this.dispatchEvent(new CustomEvent("alert-action-click",{detail:{secondary:t!=null?t:!1}})),this.hide()}static get styles(){return[super.styles,m`
		...
		`]}render(){let t=s;switch(this.status){case"info":t=i`
				...
				`;break;case"none":default:t=s;break}return i`
			<omni-modal part="modal" no-fullscreen no-header no-footer hide>
                    <div part="content" class="content">
                        <div part="header" class="header ${this.headerAlign}">
                            ...
                            <slot name="header">
                                ${this.message?i`<div class="message">${this.message}</div>`:s}
                            </slot>
                        </div>
                        ${this.description?this.description.split(`
`).map(e=>i`<div class="description">${e}</div>`):s}
                        <slot>
                        </slot>
                    </div>
                    <div part="actions" class="actions ${this.actionAlign}">
                        ${this.enableSecondary?i`
		...
		`}};a([h("omni-modal")],o.prototype,"modal",2),a([d({type:String,reflect:!0})],o.prototype,"status",2),a([d({type:String,reflect:!0})],o.prototype,"message",2),a([d({type:String,attribute:"header-align",reflect:!0})],o.prototype,"headerAlign",2),a([d({type:String,reflect:!0})],o.prototype,"description",2),a([d({type:String,reflect:!0,attribute:"primary-action"})],o.prototype,"primaryAction",2),a([d({type:String,reflect:!0,attribute:"secondary-action"})],o.prototype,"secondaryAction",2),a([d({type:Boolean,reflect:!0,attribute:"enable-secondary"})],o.prototype,"enableSecondary",2),a([d({type:String,attribute:"action-align",reflect:!0})],o.prototype,"actionAlign",2),o=a([p("omni-alert")],o);export{o as a};
//# sourceMappingURL=chunk.ZIBUPWM7.js.map
