...
test(`Currency Field - Visual and Behaviour`, async ({ page }) => {
    await withCoverage(page, async () => {
        ...
        await currencyField.evaluate((c, number) => (c.value = number), number);
        ...
        // await keyboardPaste(page);
        await currencyField.evaluate((c, invalidNumber) => (c.value = invalidNumber), invalidNumber);
        ...
        await currencyField.evaluate((c, numericValue) => (c.value = numericValue), numericValue);
