import"../chunks-js/chunk.22BPMVXX.js";import"../chunks-js/chunk.Y2FJIW7X.js";import"../chunks-js/chunk.M6SSC5HK.js";import"../chunks-js/chunk.STJOQLHS.js";import"../chunks-js/chunk.XLKVLWPJ.js";import"../chunks-js/chunk.32LOAOEJ.js";import{a as L,b as x,c as E,e as M,f as R,g as H,h as P}from"../chunks-js/chunk.XQKGAXIJ.js";import"../chunks-js/chunk.K2UMXYHA.js";import"../chunks-js/chunk.CQEQBUXK.js";import"../chunks-js/chunk.E3RY574V.js";import"../chunks-js/chunk.XGCBNSF2.js";import{a as D}from"../chunks-js/chunk.IRJIQSYL.js";import{a as v}from"../chunks-js/chunk.G3QHRCKP.js";import{a as $,b as r}from"../chunks-js/chunk.MHLMY33S.js";import{l as I,w as A,y as c}from"../chunks-js/chunk.BM33DA64.js";import"../chunks-js/chunk.P3AVSJ2D.js";import"../chunks-js/chunk.H2SV3XAM.js";import"../chunks-js/chunk.U46MGZPC.js";import"../chunks-js/chunk.ZPV4YWBP.js";import{a as m}from"../chunks-js/chunk.6QCQBNRL.js";import{c as h}from"../chunks-js/chunk.N6OKW4B2.js";import{d as a}from"../chunks-js/chunk.W54IKPJD.js";import"../chunks-js/chunk.B6SUKNHE.js";import"../chunks-js/chunk.2HYOR3YM.js";import"../chunks-js/chunk.CWNKFZ3E.js";import"../chunks-js/chunk.S2K25ADN.js";import{b as d,d as S}from"../chunks-js/chunk.F6MIXR4E.js";import{h as j,m as F,p as C}from"../chunks-js/chunk.BF43NN75.js";F();C();var y=j(D(),1);var pe={title:"UI Components/Select",component:"omni-select"},b=[{id:"1",label:"Peter Parker"},{id:"2",label:"James Howlett"},{id:"3",label:"Tony Stark"},{id:"4",label:"Steve Rodgers"},{id:"5",label:"Bruce Banner"},{id:"6",label:"Wanda Maximoff"},{id:"7",label:"TChalla"},{id:"8",label:"Henry P. McCoy"},{id:"9",label:"Carl Lucas"},{id:"10",label:"Frank Castle"}],g=["Bruce Wayne","Clark Kent","Barry Allen","Arthur Curry","Hal Jordan"];async function Z(e){return await new Promise(t=>setTimeout(()=>t(),2e3)),e}async function W(e,t){return await new Promise(l=>setTimeout(()=>l(),2e3)),O(e,t)}function O(e,t){return Array.isArray(t)&&e!==null?t=t.filter(l=>J(e,l)):t}function J(e,t){return t.toString().toLowerCase().includes(e.toLowerCase())}var ye={render:e=>d`
        <omni-select
...
`}${v(I("prefix",e.prefix))}`:S}
            ${e.clear?d`${`\r
`}${v(I("clear",e.clear))}`:S}${e.suffix?d`${`\r
...
const stringItems = ['Bruce Wayne', 'Clark Kent', 'Barry Allen', 'Arthur Curry', 'Hal Jordan'];    
const App = () => <OmniSelect label="${e.label}" display-field="${e.displayField}" id-field="${e.idField}" items={stringItems} />;`}],name:"String",description:"Use a string array as the items source.",args:{label:"String",data:{},items:g,displayField:"label",idField:"id"},play:async e=>{var o;let t=h(e.canvasElement).getByTestId("test-select"),l=y.fn(),i=y.fn();t.addEventListener("click",l),t.addEventListener("change",i),await r.click(t);let s=await c(t.shadowRoot,".item");await r.click(s);let n=(o=t.shadowRoot)==null?void 0:o.getElementById("select");await a(n).toHaveValue(g[0])}},fe={render:e=>d`
        <omni-select
            data-testid="test-select"
            label="${m(e.label)}"
            .items="${e.items}"
...
`,frameworkSources:[{framework:"HTML",load:e=>`<omni-select id='omni-select' label="${e.label}" searchable></omni-select>
    ...
    <\/script>`},{framework:"React",load:e=>`import { OmniSelect } from "@capitec/omni-components-react/select";
        ...
        </OmniSelect>`}],name:"Custom Search",description:"Custom search function",args:{label:"Custom Search",searchable:!0,items:g,filterItems:O},play:async e=>{var w,u;let t=h(e.canvasElement).getByTestId("test-select"),l=y.fn();t.addEventListener("click",l),await r.click(t);let i=await c(t.shadowRoot,"#searchField");await a(i).toBeTruthy(),$(i),await r.click(i);let s="Bruce";await r.type(i,s);let n=await c(t.shadowRoot,"#items-container");await a(n).toBeTruthy();let o=(w=t.shadowRoot)==null?void 0:w.getElementById("items");await a(o).toBeTruthy();let p=await c(t.shadowRoot,".item");await a(p).toBeTruthy(),await r.click(p);let f=(u=t.shadowRoot)==null?void 0:u.getElementById("select");await a(f).toHaveValue(g[0])}},Ie={render:e=>d`
    <omni-select data-testid="test-select" label="${m(e.label)}" .items="${e.items}" ?searchable="${e.searchable}" .filterItems="${e.filterItems}">
    </omni-select>
`,frameworkSources:[{framework:"HTML",load:e=>`<omni-select id='omni-select' label="${e.label}" searchable></omni-select>
    <script defer>
    ...
    <\/script>`},{framework:"React",load:e=>`import { OmniSelect } from "@capitec/omni-components-react/select";
        ...
        const App = () => <OmniSelect label="${e.label}" items={stringItems} filterItems={searchFilter} searchable></OmniSelect>`}],name:"Server Side Filtering",description:"Select with server side filtering",args:{label:"Server Side Filtering",searchable:!0,items:g,filterItems:W},play:async e=>{var w,u;let t=h(e.canvasElement).getByTestId("test-select"),l=y.fn();t.addEventListener("click",l),await r.click(t);let i=await c(t.shadowRoot,"#searchField");await a(i).toBeTruthy(),$(i),await r.click(i);let s="Bruce";await r.type(i,s);let n=await c(t.shadowRoot,"#items-container");await a(n).toBeTruthy();let o=(w=t.shadowRoot)==null?void 0:w.getElementById("items");await a(o).toBeTruthy();let p;navigator.userAgent==="Test Runner"?p=await c(t.shadowRoot,".item",void 0,3e3):p=await c(t.shadowRoot,".item",void 0,5e3),await a(p).toBeTruthy(),await r.click(p);let f=(u=t.shadowRoot)==null?void 0:u.getElementById("select");await a(f).toHaveValue(g[0])}},Be={render:e=>d`
