import"../chunks-js/chunk.RGVBMT3I.js";import"../chunks-js/chunk.Y2FJIW7X.js";import"../chunks-js/chunk.M6SSC5HK.js";import"../chunks-js/chunk.STJOQLHS.js";import"../chunks-js/chunk.XLKVLWPJ.js";import"../chunks-js/chunk.32LOAOEJ.js";import{a as L,b as x,c as E,e as M,f as R,g as H,h as P}from"../chunks-js/chunk.6KQOIOYE.js";import"../chunks-js/chunk.K2UMXYHA.js";import"../chunks-js/chunk.I3LVDBCB.js";import"../chunks-js/chunk.E3RY574V.js";import"../chunks-js/chunk.XGCBNSF2.js";import{a as D}from"../chunks-js/chunk.IRJIQSYL.js";import{a as v}from"../chunks-js/chunk.G3QHRCKP.js";import{a as $,b as r}from"../chunks-js/chunk.MHLMY33S.js";import{l as I,w as A,y as c}from"../chunks-js/chunk.G6V5HYSG.js";import"../chunks-js/chunk.U46MGZPC.js";import"../chunks-js/chunk.P3AVSJ2D.js";import"../chunks-js/chunk.H2SV3XAM.js";import"../chunks-js/chunk.ZPV4YWBP.js";import{a as m}from"../chunks-js/chunk.6QCQBNRL.js";import{c as h}from"../chunks-js/chunk.N6OKW4B2.js";import{d as a}from"../chunks-js/chunk.W54IKPJD.js";import"../chunks-js/chunk.B6SUKNHE.js";import"../chunks-js/chunk.2HYOR3YM.js";import"../chunks-js/chunk.CWNKFZ3E.js";import"../chunks-js/chunk.S2K25ADN.js";import{b as d,d as g}from"../chunks-js/chunk.F6MIXR4E.js";import{h as j,m as F,p as C}from"../chunks-js/chunk.BF43NN75.js";F();C();var y=j(D(),1);var pe={title:"UI Components/Select",component:"omni-select"},b=[{id:"1",label:"Peter Parker"},{id:"2",label:"James Howlett"},{id:"3",label:"Tony Stark"},{id:"4",label:"Steve Rodgers"},{id:"5",label:"Bruce Banner"},{id:"6",label:"Wanda Maximoff"},{id:"7",label:"TChalla"},{id:"8",label:"Henry P. McCoy"},{id:"9",label:"Carl Lucas"},{id:"10",label:"Frank Castle"}],S=["Bruce Wayne","Clark Kent","Barry Allen","Arthur Curry","Hal Jordan"];async function Z(e){return await new Promise(t=>setTimeout(()=>t(),2e3)),e}async function W(e,t){return await new Promise(i=>setTimeout(()=>i(),2e3)),O(e,t)}function O(e,t){return Array.isArray(t)&&e!==null?t=t.filter(i=>J(e,i)):t}function J(e,t){return t.toString().toLowerCase().includes(e.toLowerCase())}var ye={render:e=>d`
        <omni-select
...
`:g}</omni-select
        >
    `,name:"Interactive",args:{label:"Label",value:"",hint:"",error:"",disabled:!1,clearable:!1,searchable:!1,prefix:"",suffix:"",clear:"",items:b,displayField:"label",idField:"id",loading_indicator:"",emptyMessage:"No items provided"},play:async e=>{var w,u,B;let t=h(e.canvasElement).getByTestId("test-select"),i=y.fn(),l=y.fn();t.addEventListener("click",i),t.addEventListener("change",l),await r.click(t),await r.click(t),await a(i).toBeCalledTimes(2);let s=(w=t.shadowRoot)==null?void 0:w.getElementById("control");await a(s).toBeTruthy(),await r.click(t);let n=await c(t.shadowRoot,"#items-container");await a(n).toBeTruthy();let o=(u=t.shadowRoot)==null?void 0:u.getElementById("items");await a(o).toBeTruthy();let p=await c(t.shadowRoot,".item");await a(p).toBeTruthy(),await r.click(p);let f=(B=t.shadowRoot)==null?void 0:B.getElementById("select");await a(f).toHaveValue(b[0].label),await a(l).toBeCalledTimes(1)}},we={render:e=>d`
        <omni-select
            data-testid="test-select"
            label="${m(e.label)}"
            .data="${e.data}"
...
const App = () => <OmniSelect label="${e.label}" items={stringItems}>                    
                    <svg slot="arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px" style={{fill: 'orange'}}><path d="M12 2.25c5.385 0 9.75 4.365 9.75 9.75s-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12 6.615 2.25 12 2.25Zm0 1.5a8.25 8.25 0 1 0 0 16.5 8.25 8.25 0 0 0 0-16.5ZM12 7a.75.75 0 0 1 .75.75v3.5h3.5a.75.75 0 0 1 .743.648L17 12a.75.75 0 0 1-.75.75h-3.5v3.5a.75.75 0 0 1-.648.743L12 17a.75.75 0 0 1-.75-.75v-3.5h-3.5a.75.75 0 0 1-.743-.648L7 12a.75.75 0 0 1 .75-.75h3.5v-3.5a.75.75 0 0 1 .648-.743Z"/></svg>
                    <svg slot="more" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px" style={{fill: 'orange'}}><path d="M12 2.25c5.385 0 9.75 4.365 9.75 9.75s-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12 6.615 2.25 12 2.25Zm0 1.5a8.25 8.25 0 1 0 0 16.5 8.25 8.25 0 0 0 0-16.5ZM12 7a.75.75 0 0 1 .75.75v3.5h3.5a.75.75 0 0 1 .743.648L17 12a.75.75 0 0 1-.75.75h-3.5v3.5a.75.75 0 0 1-.648.743L12 17a.75.75 0 0 1-.75-.75v-3.5h-3.5a.75.75 0 0 1-.743-.648L7 12a.75.75 0 0 1 .75-.75h3.5v-3.5a.75.75 0 0 1 .648-.743Z"/></svg>
                  </OmniSelect>;`}],name:"Custom Control Slot",description:"Set html content to display within the available control slots.",args:{label:"Custom slots",items:S},play:async e=>{var i,l;let t=h(e.canvasElement).getByTestId("test-select");if(window.matchMedia?window.matchMedia("screen and (min-width: 767px)").matches:window.innerWidth>=767){let s=(i=t.shadowRoot)==null?void 0:i.querySelector("slot[name=arrow]");await a(s).toBeTruthy();let n=s==null?void 0:s.assignedElements().find(o=>o.tagName.toLocaleLowerCase()==="svg");await a(n).toBeTruthy()}else{let s=(l=t.shadowRoot)==null?void 0:l.querySelector("slot[name=more]");await a(s).toBeTruthy();let n=s==null?void 0:s.assignedElements().find(o=>o.tagName.toLocaleLowerCase()==="svg");await a(n).toBeTruthy()}}},ge={render:e=>d`
...
const App = () => <OmniSelect label="${e.label}" display-field="${e.displayField}" id-field="${e.idField}" items={displayItems} searchable></OmniSelect>`}],name:"Searchable",description:"Adds a search input to limit the options to Select",args:{label:"Searchable",displayField:"label",idField:"id",searchable:!0,items:b},play:async e=>{var w,u;let t=h(e.canvasElement).getByTestId("test-select"),i=y.fn();t.addEventListener("click",i),await r.click(t);let l=await c(t.shadowRoot,"#searchField");await a(l).toBeTruthy(),$(l),await r.click(l);let s="Peter";await r.type(l,s);let n=await c(t.shadowRoot,"#items-container");await a(n).toBeTruthy();let o=(w=t.shadowRoot)==null?void 0:w.getElementById("items");await a(o).toBeTruthy();let p=await c(t.shadowRoot,".item");await a(p).toBeTruthy(),await r.click(p);let f=(u=t.shadowRoot)==null?void 0:u.getElementById("select");await a(f).toHaveValue(b[0].label)}},ve={render:e=>d`
...
</OmniSelect>`}],name:"Custom Search",description:"Custom search function",args:{label:"Custom Search",searchable:!0,items:S,filterItems:O},play:async e=>{var w,u;let t=h(e.canvasElement).getByTestId("test-select"),i=y.fn();t.addEventListener("click",i),await r.click(t);let l=await c(t.shadowRoot,"#searchField");await a(l).toBeTruthy(),$(l),await r.click(l);let s="Bruce";await r.type(l,s);let n=await c(t.shadowRoot,"#items-container");await a(n).toBeTruthy();let o=(w=t.shadowRoot)==null?void 0:w.getElementById("items");await a(o).toBeTruthy();let p=await c(t.shadowRoot,".item");await a(p).toBeTruthy(),await r.click(p);let f=(u=t.shadowRoot)==null?void 0:u.getElementById("select");await a(f).toHaveValue(S[0])}},Ie={render:e=>d`
    <omni-select data-testid="test-select" label="${m(e.label)}" .items="${e.items}" ?searchable="${e.searchable}" .filterItems="${e.filterItems}">
    </omni-select>
`,frameworkSources:[{framework:"HTML",load:e=>`<omni-select id='omni-select' label="${e.label}" searchable></omni-select>
    <script defer>
...
<svg slot="search-clear" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px" style={{fill: 'orange'}}><path d="M12 2.25c5.385 0 9.75 4.365 9.75 9.75s-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12 6.615 2.25 12 2.25Zm0 1.5a8.25 8.25 0 1 0 0 16.5 8.25 8.25 0 0 0 0-16.5ZM8.47 8.47a.75.75 0 0 1 1.06 0L12 10.939l2.47-2.47a.75.75 0 0 1 .976-.072l.084.073a.75.75 0 0 1 0 1.06L13.061 12l2.47 2.47a.75.75 0 0 1 .072.976l-.073.084a.75.75 0 0 1-1.06 0L12 13.061l-2.47 2.47a.75.75 0 0 1-.976.072l-.084-.073a.75.75 0 0 1 0-1.06L10.939 12l-2.47-2.47a.75.75 0 0 1-.072-.976Z" /></svg>
</OmniSelect>`}],name:"Custom Search Field Slot",description:"Select component with search field custom slotted icon.",args:{label:"Custom Search Slot",searchable:!0,items:S},play:async e=>{var B,k,T;let t=h(e.canvasElement).getByTestId("test-select"),i=y.fn();t.addEventListener("click",i),await r.click(t);let l=await c(t.shadowRoot,"#searchField");await a(l).toBeTruthy(),$(l),await r.click(l);let s="Bruce";await r.type(l,s);let n=(B=t.shadowRoot)==null?void 0:B.querySelector("slot[name=search-clear]");await a(n).toBeTruthy();let o=n==null?void 0:n.assignedElements().find(_=>_.tagName.toLocaleLowerCase()==="svg");await a(o).toBeTruthy();let p=await c(t.shadowRoot,"#items-container");await a(p).toBeTruthy();let f=(k=t.shadowRoot)==null?void 0:k.getElementById("items");await a(f).toBeTruthy();let w=await c(t.shadowRoot,".item");await a(w).toBeTruthy(),await r.click(w);let u=(T=t.shadowRoot)==null?void 0:T.getElementById("select");await a(u).toHaveValue(S[0])}},$e=L("omni-select"),ke=x("omni-select"),Te=E("omni-select"),Fe=H("omni-select"),Ce=P("omni-select"),Ae=M("omni-select"),Le=R("omni-select");export{we as Async_Per_Item,Fe as Clearable,Ce as Custom_Clear_Slot,Se as Custom_Control_Slot,ve as Custom_Search,Be as Custom_Search_Slot,be as Disabled,fe as Empty_Message,Te as Error_Label,ke as Hint,ye as Interactive,$e as Label,ue as Loading_Slot,Ae as Prefix,ge as Searchable,Ie as Server_Side_Filtering,he as String_Array,Le as Suffix,pe as default};
