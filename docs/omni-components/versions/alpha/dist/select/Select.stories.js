import"../chunks-js/chunk.JQGT5LNQ.js";import"../chunks-js/chunk.Y2FJIW7X.js";import"../chunks-js/chunk.M6SSC5HK.js";import"../chunks-js/chunk.STJOQLHS.js";import"../chunks-js/chunk.XLKVLWPJ.js";import"../chunks-js/chunk.32LOAOEJ.js";import{a as B,b as T,c as F,e as C,f as L,g as A}from"../chunks-js/chunk.YD3W5R6Q.js";import"../chunks-js/chunk.K2UMXYHA.js";import"../chunks-js/chunk.P5BVWJU5.js";import"../chunks-js/chunk.E3RY574V.js";import"../chunks-js/chunk.XGCBNSF2.js";import{a as H}from"../chunks-js/chunk.IRJIQSYL.js";import{a as u}from"../chunks-js/chunk.G3QHRCKP.js";import{b as r}from"../chunks-js/chunk.MHLMY33S.js";import{l as b,w as k,y as p}from"../chunks-js/chunk.BM33DA64.js";import"../chunks-js/chunk.P3AVSJ2D.js";import"../chunks-js/chunk.H2SV3XAM.js";import"../chunks-js/chunk.U46MGZPC.js";import"../chunks-js/chunk.ZPV4YWBP.js";import{a as s}from"../chunks-js/chunk.PJH7M65U.js";import{c as y}from"../chunks-js/chunk.N6OKW4B2.js";import{d as a}from"../chunks-js/chunk.W54IKPJD.js";import"../chunks-js/chunk.B6SUKNHE.js";import"../chunks-js/chunk.2HYOR3YM.js";import"../chunks-js/chunk.CWNKFZ3E.js";import"../chunks-js/chunk.S2K25ADN.js";import{b as c,d as f}from"../chunks-js/chunk.F6MIXR4E.js";import{h as R,m as I,p as x}from"../chunks-js/chunk.BF43NN75.js";I();x();var m=R(H(),1);var le={title:"UI Components/Select",component:"omni-select"},w=[{id:"1",label:"Peter Parker"},{id:"2",label:"James Howlett"},{id:"3",label:"Tony Stark"},{id:"4",label:"Steve Rodgers"},{id:"5",label:"Bruce Banner"},{id:"6",label:"Wanda Maximoff"},{id:"7",label:"TChalla"},{id:"8",label:"Henry P. McCoy"},{id:"9",label:"Carl Lucas"},{id:"10",label:"Frank Castle"}],h=["Bruce Wayne","Clark Kent","Barry Allen","Arthur Curry","Hal Jordan"];async function E(e){return await new Promise(t=>setTimeout(()=>t(),2e3)),e}var ae={render:e=>c`
        <omni-select
            ...
            >${e.prefix?c`${`\r
`}${u(b("prefix",e.prefix))}`:f}${e.suffix?c`${`\r
...
`:f}</omni-select
        >
    `,name:"Interactive",args:{label:"Label",value:"",hint:"",error:"",disabled:!1,clearable:!1,prefix:"",suffix:"",items:w,displayField:"label",idField:"id",loading_indicator:"",emptyMessage:"No items provided"},play:async e=>{var v,S,$;let t=y(e.canvasElement).getByTestId("test-select"),l=m.fn(),n=m.fn();t.addEventListener("click",l),t.addEventListener("change",n),await r.click(t),await r.click(t),await a(l).toBeCalledTimes(2);let i=(v=t.shadowRoot)==null?void 0:v.getElementById("control");await a(i).toBeTruthy(),await r.click(t);let d=await p(t.shadowRoot,"#items-container");await a(d).toBeTruthy();let o=(S=t.shadowRoot)==null?void 0:S.getElementById("items");await a(o).toBeTruthy();let g=await p(t.shadowRoot,".item");await a(g).toBeTruthy(),await r.click(g);let M=($=t.shadowRoot)==null?void 0:$.getElementById("select");await a(M).toHaveValue(w[0].label),await a(n).toBeCalledTimes(1)}},se={render:e=>c`
        <omni-select
            data-testid="test-select"
            label="${s(e.label)}"
            .data="${e.data}"
