import"../chunks-js/chunk.PKO3EBCH.js";import"../chunks-js/chunk.DRHLE6Y6.js";import"../chunks-js/chunk.N57I3NXS.js";import"../chunks-js/chunk.VAH5TOPR.js";import{a as B}from"../chunks-js/chunk.JSH3M4FH.js";import{b as h}from"../chunks-js/chunk.XOIHXH3W.js";import{b as t}from"../chunks-js/chunk.FVJIJQ42.js";import{c as T}from"../chunks-js/chunk.WPESAYH2.js";import"../chunks-js/chunk.TTUIP4EN.js";import{E as v,m as E,x as u,z as d}from"../chunks-js/chunk.LSBYP56E.js";import"../chunks-js/chunk.U46MGZPC.js";import"../chunks-js/chunk.Z5LIJAXH.js";import"../chunks-js/chunk.H2SV3XAM.js";import"../chunks-js/chunk.VW2P7YAN.js";import"../chunks-js/chunk.MYG5FMLT.js";import"../chunks-js/chunk.2EDJFZZN.js";import{a as w}from"../chunks-js/chunk.N3FDHMD3.js";import"../chunks-js/chunk.YX3UUKJ3.js";import"../chunks-js/chunk.XUUOUKOL.js";import"../chunks-js/chunk.LB764BBD.js";import"../chunks-js/chunk.LUCH4Y6K.js";import"../chunks-js/chunk.PNTHLTQK.js";import"../chunks-js/chunk.S2K25ADN.js";import{b as i,e as g}from"../chunks-js/chunk.L3RZWW2F.js";import{h as H,m as y,p as L}from"../chunks-js/chunk.BF43NN75.js";y();L();var S=H(B(),1);var X={title:"UI Components/Tabs",component:"omni-tabs",argTypes:{header:{control:"text"}}},A={render:a=>i`
    <omni-tabs data-testid='test-tabs'>
        ${a.header?i`${`\r
`}${w(E("header",a.header))}`:g}
        ${a["[Default Slot]"]?i`${`\r
`}${w(a["[Default Slot]"])}`:g}
    </omni-tabs>
...
<OmniTab header="Tab 3">
    ...
    `,args:{"[Default Slot]":u`<omni-tab header='Tab 1'>
        ...
        `},play:async a=>{let e=T(a.canvasElement).getByTestId("test-tabs"),n=await d(e.shadowRoot,".tab-bar");await t(n).toBeTruthy();let l=[...n.querySelectorAll("omni-tab-header")];await t(l.length).toBe(3);let r=(await d(e.shadowRoot,"slot:not([name])")).assignedElements();await t(r.length).toBe(3)}},p={render:()=>i`
    <omni-tabs data-testid='test-tabs'>
...
`,frameworkSources:[{framework:"Vue",load:a=>{var e;return v((e=p==null?void 0:p.render)==null?void 0:e.call(p,a),void 0,n=>n.replace(" active",' :active="true"'))}},{framework:"React",load:()=>`import { OmniTabs, OmniTab } from "@capitec/omni-components-react/tab";
import { OmniLabel } from "@capitec/omni-components-react/label";
...
<OmniTab id="right">
 <div>Right</div>
    ...
    <div>
    `,play:async a=>{let e=T(a.canvasElement).getByTestId("test-tabs"),n=await d(e.shadowRoot,".tab-bar");await t(n).toBeTruthy();let m=n.querySelector('slot[name="header"]');await t(m).toBeTruthy();let l=m==null?void 0:m.assignedElements().filter(b=>b.tagName.toLowerCase()==="omni-tab-header");await t(l).toBeTruthy();let o=l==null?void 0:l.find(b=>b.hasAttribute("data-active"));await t(o).toBeTruthy();let r=o==null?void 0:o.querySelector("omni-icon");await t(r).toBeTruthy();let c=o==null?void 0:o.querySelector("svg");await t(c).toBeTruthy(),await h.click(l[1]);let O=l.find(b=>b.hasAttribute("data-active"));await t(O).toBeTruthy()}};export{p as Active,_ as Advanced,Y as Basic,f as Disabled,A as Interactive,X as default};
