import{c as i}from"../chunks-js/chunk.5LOR7L6U.js";import"../chunks-js/chunk.VB3ZKFMN.js";import"../chunks-js/chunk.DXJESG3Z.js";import{E as l,m as n,x as c}from"../chunks-js/chunk.TJTW5ASN.js";import"../chunks-js/chunk.H2SV3XAM.js";import"../chunks-js/chunk.U46MGZPC.js";import"../chunks-js/chunk.Z5LIJAXH.js";import"../chunks-js/chunk.VW2P7YAN.js";import"../chunks-js/chunk.MYG5FMLT.js";import"../chunks-js/chunk.2EDJFZZN.js";import{a as o}from"../chunks-js/chunk.N3FDHMD3.js";import"../chunks-js/chunk.YX3UUKJ3.js";import"../chunks-js/chunk.XUUOUKOL.js";import"../chunks-js/chunk.LB764BBD.js";import{a}from"../chunks-js/chunk.XCXCHO25.js";import"../chunks-js/chunk.KRAWXAJA.js";import"../chunks-js/chunk.LUCH4Y6K.js";import"../chunks-js/chunk.PNTHLTQK.js";import"../chunks-js/chunk.S2K25ADN.js";import{b as t,e as s}from"../chunks-js/chunk.L3RZWW2F.js";import{m as r,p as d}from"../chunks-js/chunk.BF43NN75.js";r();d();var I={title:"UI Components/Toast",component:"omni-toast"},m={render:e=>t`
        <omni-toast
            ...
            ${e.prefix?t`${o(n("prefix",e.prefix))}`:s}
            ${o(e["[Default Slot]"])}
            ${e.close?t`${o(n("close",e.close))}`:s}
        </omni-toast>
    `,frameworkSources:[{framework:"Vue",load:e=>l(m.render(e)).replaceAll(" closeable",' :closeable="true"')}],name:"Interactive",args:{closeable:!1,detail:"The toast description",header:"The toast header",type:"success",prefix:void 0,"[Default Slot]":void 0,close:void 0}},B={description:()=>t`
    <div>
...
const App = () => <OmniButton label="Show Toast" onclick={showToast}/>;`}],name:"Configure Toast Programmatically",args:{}},R={description:()=>t`
    <div>
    ...
    `,frameworkSources:[{framework:"HTML",sourceParts:{htmlFragment:c`<omni-button label="Stack Toast"></omni-button>`,jsFragment:`import { Toast } from '@capitec/omni-components/toast';
...
const App = () => <OmniButton label="Stack Toast" onclick={showToast}/>;`}],name:"Stacking Toast Programmatically",args:{}},Z={description:()=>t`
    <div>
...
const App = () =>   <OmniToast${e.detail?` detail="${e.detail}"`:""}${e.header?` header="${e.header}"`:""}${e.type?` type="${e.type}"`:""}${e.closeable?" closeable":""}>
                    ...
                    </OmniToast>;`}],name:"Custom Slotted Content",args:{closeable:!1,detail:"",header:"The toast header",type:"none",prefix:void 0,"[Default Slot]":c`<span>Custom Slotted Toast <strong>Content</strong></span>`,close:void 0}},P={description:()=>t`
    <div>
...
const App = () => <OmniToast${e.detail?` detail="${e.detail}"`:""}${e.header?` header="${e.header}"`:""}${e.type?` type="${e.type}"`:""}${e.closeable?" closeable":""}/>;`}],name:"Closeable",args:{closeable:!0,detail:"The toast description",header:"The toast header",type:"none",prefix:void 0,"[Default Slot]":void 0,close:void 0}},u={description:()=>t`
    <div>
    ...
    `,frameworkSources:[{framework:"Vue",load:e=>l(u.render(e)).replaceAll(" closeable",' :closeable="true"')},{framework:"React",load:e=>`import { OmniToast } from "@capitec/omni-components-react/toast";
...
const App = () => <OmniToast${e.detail?` detail="${e.detail}"`:""}${e.header?` header="${e.header}"`:""}${e.type?` type="${e.type}"`:""}${e.closeable?" closeable":""}/>;`}],name:"Type",args:{closeable:!1,detail:"The toast description",header:"The toast header",type:"warning",prefix:void 0,"[Default Slot]":void 0,close:void 0}};export{p as Closeable,M as Configure_Toast,u as Custom_Slotted_Close,Z as Custom_Slotted_Content,P as Custom_Slotted_Prefix,m as Interactive,B as Showing_Toasts,R as Stacking_Toasts,_ as Type,I as default};
