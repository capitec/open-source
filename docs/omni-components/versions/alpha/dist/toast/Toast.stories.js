import{c}from"../chunks-js/chunk.NCDGEC3N.js";import"../chunks-js/chunk.VB3ZKFMN.js";import"../chunks-js/chunk.DXJESG3Z.js";import{E as l,m as n,x as i}from"../chunks-js/chunk.TJTW5ASN.js";import"../chunks-js/chunk.H2SV3XAM.js";import"../chunks-js/chunk.U46MGZPC.js";import"../chunks-js/chunk.Z5LIJAXH.js";import"../chunks-js/chunk.VW2P7YAN.js";import"../chunks-js/chunk.MYG5FMLT.js";import"../chunks-js/chunk.2EDJFZZN.js";import{a as o}from"../chunks-js/chunk.N3FDHMD3.js";import"../chunks-js/chunk.YX3UUKJ3.js";import"../chunks-js/chunk.XUUOUKOL.js";import"../chunks-js/chunk.LB764BBD.js";import{a as s}from"../chunks-js/chunk.XCXCHO25.js";import"../chunks-js/chunk.KRAWXAJA.js";import"../chunks-js/chunk.LUCH4Y6K.js";import"../chunks-js/chunk.PNTHLTQK.js";import"../chunks-js/chunk.S2K25ADN.js";import{b as t,e as a}from"../chunks-js/chunk.L3RZWW2F.js";import{m as r,p as d}from"../chunks-js/chunk.BF43NN75.js";r();d();var O={title:"UI Components/Toast",component:"omni-toast"},m={render:e=>t`
        <omni-toast
    ...
    `,frameworkSources:[{framework:"Vue",load:e=>l(m.render(e)).replaceAll(" closeable",' :closeable="true"')}],name:"Interactive",args:{closeable:!1,detail:"The toast description",header:"The toast header",type:"success",prefix:void 0,"[Default Slot]":void 0,close:void 0}},P={description:()=>t`
    <div>
...
const App = () => <OmniButton label="Show Toast" onclick={showToast}/>;`}],name:"Showing Toast Programmatically",args:{}},R={description:()=>t`
    <div>
...
const App = () => <OmniButton label="Show Toast" onclick={showToast}/>;`}],name:"Configure Toast Programmatically",args:{}},B={description:()=>t`
    <div>
...
const App = () => <OmniButton label="Show Toast" onclick={showToast}/>;`}],name:"Replacing Toast Programmatically",args:{}},L={description:()=>t`
    <div>
...
const App = () =>   <OmniToast${e.detail?` detail="${e.detail}"`:""}${e.header?` header="${e.header}"`:""}${e.type?` type="${e.type}"`:""}${e.closeable?" closeable":""}>
                    ...
                    </OmniToast>;`}],name:"Custom Slotted Content",args:{closeable:!1,detail:"",header:"The toast header",type:"none",prefix:void 0,"[Default Slot]":i`<span>Custom Slotted Toast <strong>Content</strong></span>`,close:void 0}},M={description:()=>t`
    <div>
...
const App = () =>   <OmniToast${e.detail?` detail="${e.detail}"`:""}${e.header?` header="${e.header}"`:""}${e.type?` type="${e.type}"`:""}${e.closeable?" closeable":""}>
    ...
    <path d="M8.138 5.035c5.173-2.112 10.332.032 15.368 6.273a1.12 1.12 0 0 1-.002 1.398c-1.735 2.136-3.489 3.796-5.252 4.966a13.433 13.433 0 0 1-2.846 1.46A9.952 9.952 0 0 1 12 19.75c-3.859 0-7.724-2.391-11.504-7.044a1.119 1.119 0 0 1-.002-1.398C2.002 9.44 3.519 7.938 5.045 6.81A14.573 14.573 0 0 1 7.86 5.153Zm13.684 6.59c-4.56-5.382-8.973-7.018-13.36-5.098-.836.365-1.677.861-2.524 1.488-1.417 1.048-2.845 2.46-4.276 4.234l.2-.244.394.467c3.12 3.629 6.205 5.542 9.179 5.757l.287.016.278.005c.956 0 1.92-.175 2.895-.528a11.942 11.942 0 0 0 2.527-1.3c1.628-1.08 3.273-2.637 4.917-4.66l-.044.05-.158.192ZM12 7.25a4.75 4.75 0 1 1 0 9.5 4.75 4.75 0 0 1 0-9.5Zm0 1.5a3.25 3.25 0 1 0 0 6.5 3.25 3.25 0 0 0 0-6.5Z" />
</svg>`,"[Default Slot]":void 0,close:void 0}},u={description:()=>t`Add a close button to the <code class="language-html">&lt;omni-toast&gt;</code>.`,render:e=>t`
        <omni-toast
            data-testid="test-toast"
            detail="${s(e.detail)}"
            header="${s(e.header)}"
...
const App = () => <OmniToast${e.detail?` detail="${e.detail}"`:""}${e.header?` header="${e.header}"`:""}${e.type?` type="${e.type}"`:""}${e.closeable?" closeable":""}/>;`}],name:"Type",args:{closeable:!1,detail:"The toast description",header:"The toast header",type:"warning",prefix:void 0,"[Default Slot]":void 0,close:void 0}};export{u as Closeable,R as Configure_Toast,p as Custom_Slotted_Close,L as Custom_Slotted_Content,M as Custom_Slotted_Prefix,m as Interactive,B as Replacing_Toasts,P as Showing_Toasts,Z as Type,O as default};
