import{a as ge}from"../chunks-js/chunk.EQXGZ5KJ.js";import"../chunks-js/chunk.YYDETHPF.js";import"../chunks-js/chunk.XASB34PV.js";import"../chunks-js/chunk.7GTL3UTF.js";import"../chunks-js/chunk.STJOQLHS.js";import"../chunks-js/chunk.5TKLJSC4.js";import"../chunks-js/chunk.FOZT52FM.js";import{a as Q}from"../chunks-js/chunk.K2UMXYHA.js";import"../chunks-js/chunk.AMDN2Z2F.js";import"../chunks-js/chunk.E3RY574V.js";import"../chunks-js/chunk.XGCBNSF2.js";import"../chunks-js/chunk.V3AH72NQ.js";import"../chunks-js/chunk.6QCQBNRL.js";import{E as Z,F as ye,a as te,b as ne,c as ie,d as de,e as V,f as pe,t as ue,u as he}from"../chunks-js/chunk.JVZL4EXU.js";import"../chunks-js/chunk.U46MGZPC.js";import"../chunks-js/chunk.P3AVSJ2D.js";import"../chunks-js/chunk.H2SV3XAM.js";import"../chunks-js/chunk.32OT4JFD.js";import"../chunks-js/chunk.ZPV4YWBP.js";import"../chunks-js/chunk.B6SUKNHE.js";import"../chunks-js/chunk.2HYOR3YM.js";import"../chunks-js/chunk.CWNKFZ3E.js";import{a as me,b as X,c as Y,d as D}from"../chunks-js/chunk.S2K25ADN.js";import{b as f,d as _,f as le,g as ce}from"../chunks-js/chunk.F6MIXR4E.js";import{a as ee,j as F,m as re,p as ae}from"../chunks-js/chunk.BF43NN75.js";re();ae();var b=class extends ce{constructor(){super(...arguments);this.sourceFallbacks=[{fallbackFramework:"HTML",frameworks:["HTML","Lit","Vue"],allowRenderFromResult:!0}];this.noInteractiveCodePen=["React"]}async connectedCallback(){var s;if(super.connectedCallback(),this.controller=new ge(this,this.path),this.customCss=document.head.querySelector("#custom-css-vars"),!this.customCss){this.customCss=document.createElement("style"),this.customCss.id="custom-css-vars",document.head.appendChild(this.customCss);let e=sessionStorage.getItem(`custom-css-${this.tag}`);e&&(this.customCss.innerHTML=e)}this.modal||(this.modal=document.createElement("div"),document.body.appendChild(this.modal)),this.customElements=await he();let o=pe(this.tag,this.customElements);this.cssVariables=Object.keys(o).filter(e=>o[e].subcategory==="Component Variables").map(e=>{let n=o[e];return ee({name:e},n)}),document.addEventListener("omni-docs-theme-change",e=>{var c;this.theme=(c=getComputedStyle(document.documentElement).getPropertyValue("--code-editor-theme"))==null?void 0:c.trim();let n=this.renderRoot.querySelectorAll("code-editor");n&&n.forEach(l=>{l.updateExtensions()})}),document.addEventListener("omni-docs-framework-change",async e=>{var c,l,t,d,m;let n=this.renderRoot.querySelectorAll("code-editor");if(n&&n.forEach(a=>{a.updateExtensions()}),this.codeEditor){let a=(c=window.localStorage.getItem(V))!=null?c:"HTML",r=(l=this.story.frameworkSources)==null?void 0:l.find(p=>p.framework===a);r||(a=(d=(t=this.sourceFallbacks.find(p=>p.frameworks.includes(a)))==null?void 0:t.fallbackFramework)!=null?d:a,r=(m=this.story.frameworkSources)==null?void 0:m.find(p=>p.framework===a)),await this.codeEditor.refresh(()=>{var p,y,g,S,E;return(p=r==null?void 0:r.sourceParts)!=null&&p.htmlFragment?typeof((y=r==null?void 0:r.sourceParts)==null?void 0:y.htmlFragment)=="string"?(g=r==null?void 0:r.sourceParts)==null?void 0:g.htmlFragment:(S=r==null?void 0:r.sourceParts)==null?void 0:S.htmlFragment(this.story.args):r!=null&&r.load?r.load(this.story.args,r):(E=this.sourceFallbacks.find(C=>C.frameworks.includes(a)))!=null&&E.allowRenderFromResult?Z(this.story.render(this.story.args)):""}),this.secondaryCodeEditor&&await this.secondaryCodeEditor.refresh(()=>{var y,g,S,E,C,u;let p=(y=r==null?void 0:r.sourceParts)!=null&&y.jsFragment?typeof((g=r==null?void 0:r.sourceParts)==null?void 0:g.jsFragment)=="string"?(S=r==null?void 0:r.sourceParts)==null?void 0:S.jsFragment:(E=r==null?void 0:r.sourceParts)==null?void 0:E.jsFragment(this.story.args):"";return p?((C=this.renderRoot.querySelector(".secondary-code-block"))==null||C.classList.remove("no-display"),this.renderRoot.querySelectorAll(".code-title").forEach(j=>j==null?void 0:j.classList.remove("no-display"))):((u=this.renderRoot.querySelector(".secondary-code-block"))==null||u.classList.add("no-display"),this.renderRoot.querySelectorAll(".code-title").forEach(j=>j==null?void 0:j.classList.add("no-display"))),p})}}),document.addEventListener(se,()=>{this.requestUpdate()}),this.theme=(s=getComputedStyle(document.documentElement).getPropertyValue("--code-editor-theme"))==null?void 0:s.trim()}disconnectedCallback(){this.modal&&(document.body.removeChild(this.modal),this.modal=null)}updated(o){var s;super.updated(o),(s=window.Prism)==null||s.highlightAll()}render(){var t,d,m,a,r,p,y,g,S,E,C,u,j,w,H,k,A,q,O,I,J,N,B,U,z,K,G,W;if(!((t=this.controller)!=null&&t.story))return f`<omni-loading-icon style="max-height: 64px;"></omni-loading-icon>`;le(f`
        ${this._showStylesDialog?f`
                    ...
                    <div class="component-props-table-wrapper">
                        <table class="component-props-table">
                            ...
                            <tbody data-target="custom-css-table-${this.tag}" class="component-css-props">
                                ${(d=this.cssVariables)==null?void 0:d.sort((i,v)=>this._sortCssVariables(i,v)).map(i=>f`
                                    <tr>
        ...
        `,this.modal),this.story=this.controller.story[this.key],this.story.originalArgs=(r=(m=this.story)==null?void 0:m.originalArgs)!=null?r:JSON.parse(JSON.stringify((a=this.story)==null?void 0:a.args));let o=this.story.render(this.story.args),s=(p=window.localStorage.getItem(V))!=null?p:"HTML",e=(y=this.story.frameworkSources)==null?void 0:y.find(i=>i.framework===s),n=()=>{var i,v,R,x,L;return s=(i=window.localStorage.getItem(V))!=null?i:"HTML",e=(v=this.story.frameworkSources)==null?void 0:v.find(h=>h.framework===s),e||(s=(x=(R=this.sourceFallbacks.find(h=>h.frameworks.includes(s)))==null?void 0:R.fallbackFramework)!=null?x:s,e=(L=this.story.frameworkSources)==null?void 0:L.find(h=>h.framework===s)),s};n();let c=(g=e==null?void 0:e.sourceParts)!=null&&g.htmlFragment?typeof((S=e==null?void 0:e.sourceParts)==null?void 0:S.htmlFragment)=="string"?(E=e==null?void 0:e.sourceParts)==null?void 0:E.htmlFragment:(C=e==null?void 0:e.sourceParts)==null?void 0:C.htmlFragment(this.story.args):e!=null&&e.load?e.load(this.story.args,e):(u=this.sourceFallbacks.find(i=>i.frameworks.includes(s)))!=null&&u.allowRenderFromResult?Z(o):"",l=(j=e==null?void 0:e.sourceParts)!=null&&j.jsFragment?typeof((w=e==null?void 0:e.sourceParts)==null?void 0:w.jsFragment)=="string"?(H=e==null?void 0:e.sourceParts)==null?void 0:H.jsFragment:(k=e==null?void 0:e.sourceParts)==null?void 0:k.jsFragment(this.story.args):"";return f`
            ...
            <div class="preview">
                ...
                ${this.interactive?f`
                    <div class="interactive">
                        ...
                        @property-change="${async i=>{let v=i.detail,R=!1;(!v.oldValue||!v.newValue||typeof v.newValue!="string"&&JSON.stringify(v.oldValue).trim()!==JSON.stringify(v.newValue).trim()||v.oldValue.toString().trim()!==v.newValue.toString().trim())&&(R=!0),R&&(this.story.args[v.property]=v.newValue,this.requestUpdate(),this.dispatchEvent(new CustomEvent(se,{bubbles:!0,composed:!0})),await this.updateComplete,this.codeEditor&&(n(),await this.codeEditor.refresh(()=>{var x,L,h,P,$;return(x=e==null?void 0:e.sourceParts)!=null&&x.htmlFragment?typeof((L=e==null?void 0:e.sourceParts)==null?void 0:L.htmlFragment)=="string"?(h=e==null?void 0:e.sourceParts)==null?void 0:h.htmlFragment:(P=e==null?void 0:e.sourceParts)==null?void 0:P.htmlFragment(this.story.args):e!=null&&e.load?e.load(this.story.args,e):($=this.sourceFallbacks.find(M=>M.frameworks.includes(s)))!=null&&$.allowRenderFromResult?Z(this.story.render(this.story.args)):""}),this.secondaryCodeEditor&&await this.secondaryCodeEditor.refresh(()=>{var L,h,P,$,M,oe;let x=(L=e==null?void 0:e.sourceParts)!=null&&L.jsFragment?typeof((h=e==null?void 0:e.sourceParts)==null?void 0:h.jsFragment)=="string"?(P=e==null?void 0:e.sourceParts)==null?void 0:P.jsFragment:($=e==null?void 0:e.sourceParts)==null?void 0:$.jsFragment(this.story.args):"";return x?((M=this.renderRoot.querySelector(".secondary-code-block"))==null||M.classList.remove("no-display"),this.renderRoot.querySelectorAll(".code-title").forEach(T=>T==null?void 0:T.classList.remove("no-display"))):((oe=this.renderRoot.querySelector(".secondary-code-block"))==null||oe.classList.add("no-display"),this.renderRoot.querySelectorAll(".code-title").forEach(T=>T==null?void 0:T.classList.add("no-display"))),x})))}}"></live-property-editor>
                    </div>
                    `:_}
            </div>
            <div class="code-title ${l?"":"no-display"}">HTML</div>
            <div class="code-block ${c?"":"no-display"}">
                <code-editor
...
`,"").replaceAll("\\n","").replaceAll("	","").replaceAll(" ","")}
                ...
                <div class="framework-toggles docs-omni-component">                    
                    <div class="docs-omni-component codepen-gen-btn ${((G=(K=this.story.frameworkSources)==null?void 0:K.find(i=>i.framework===s))==null?void 0:G.disableCodePen)||this.noInteractiveCodePen.includes(s)&&this.interactive?"no-display":""}" @click="${()=>{var i;return this._generateCodePen((i=window.localStorage.getItem(V))!=null?i:"HTML",c)}}">
...
ReactDOM.render(<App/>, el);`,y="babel",g="https://cdnjs.cloudflare.com/ajax/libs/react/16.7.0/umd/react.production.min.js;https://cdnjs.cloudflare.com/ajax/libs/react-dom/16.7.0/umd/react-dom.production.min.js";break}let S={title:`${(i=(W=this.key)!=null?W:(G=this.story)==null?void 0:G.name)!=null?i:"Generated CodePen"} - ${o}`,description:((v=this.story)==null?void 0:v.description)&&typeof((R=this.story)==null?void 0:R.description)=="function"?this.story.description():(x=this.story)==null?void 0:x.description,private:!1,tags:[o,"Omni Components","web components","custom elements"],editors:"1011",layout:"top",html:m,html_pre_processor:"none",css:`${a}
...
${(L=t==null?void 0:t.sourceParts)!=null&&L.cssFragment?typeof t.sourceParts.cssFragment=="function"?t.sourceParts.cssFragment(this.story.args):t.sourceParts.cssFragment:""}`,css_pre_processor:"none",css_starter:"neither",css_prefix:"neither",js:p,js_pre_processor:y,head:`<link rel="stylesheet preload" href="https://fonts.googleapis.com/css?family=Hind Vadodara" as="style">
            <link rel="stylesheet preload" href="https://fonts.googleapis.com/icon?family=Material+Icons" as="style">`,js_external:g},C=`<form style="display: none;" action="https://codepen.io/pen/define" method="POST" target="_blank"> 
            <input type="hidden" name="data" value='${JSON.stringify(S).replace(/"/g,"&quot;").replace(/'/g,"&apos;")}'>
            <input type="submit" class="code-submit">
        </form>`,u=document.createElement("div");u.innerHTML=C,u.style.display="none",document.body.appendChild(u),u.querySelector(".code-submit").click(),document.body.removeChild(u)}async _play(o,s){var e,n,c;try{if(!o.play)return;this._isBusyPlaying=!0;let l=this._createStoryContext(o,s);await o.play(l),this.querySelector(s+"-result.success").style.display="flex",this.querySelector(s+"-result.failure").style.display="none"}catch(l){this.querySelector(s+"-result.failure").style.display="flex",this.querySelector(s+"-result.success").style.display="none",this._playError=(c=(n=(e=l==null?void 0:l.matcherResult)==null?void 0:e.message)!=null?n:l==null?void 0:l.message)==null?void 0:c.toString().replace(/\u001b[^m]*?m/g,"").replace(/\n \u001b[^m]*?m/g,"").replace(/\u001b[^m]*?m\n/g,"").replace(/\n\u001b[^m]*?m/g,"")}finally{this._isBusyPlaying=!1}}_createStoryContext(o,s){return{story:o,args:o.args,canvasElement:this.querySelector(s)}}_currentCodeTheme(){var o;return((o=this.theme)==null?void 0:o.toLowerCase())==="dark"?ie:de}};F([X({type:String,reflect:!0})],b.prototype,"path",2),F([X({type:String,reflect:!0})],b.prototype,"tag",2),F([X({type:String,reflect:!0})],b.prototype,"key",2),F([X({type:Boolean,reflect:!0})],b.prototype,"interactive",2),F([Y()],b.prototype,"_interactiveSrc",2),F([Y()],b.prototype,"_isBusyPlaying",2),F([Y()],b.prototype,"_playError",2),F([Y()],b.prototype,"_showStylesDialog",2),F([D(".primary-source-code")],b.prototype,"codeEditor",2),F([D(".secondary-js-source-code")],b.prototype,"secondaryCodeEditor",2),F([D(".live-props")],b.prototype,"propertyEditor",2),b=F([me("story-renderer")],b);var se="story-renderer-interactive-update";export{b as StoryRenderer};
