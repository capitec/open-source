import{a as v}from"./chunk.K2UMXYHA.js";import{a as g}from"./chunk.AMDN2Z2F.js";import{a as n}from"./chunk.5FNBLYOK.js";import{a as d}from"./chunk.2HYOR3YM.js";import{a as f,b as c,c as l,d as u}from"./chunk.S2K25ADN.js";import{a as h,b as a,d as m}from"./chunk.F6MIXR4E.js";import{j as o,m as s,p}from"./chunk.BF43NN75.js";s();p();var t=class extends g{constructor(){super(...arguments);this.defaultLocale="en-US";this.locale=this.defaultLocale;this.date=this.value&&typeof this.value=="string"?n.fromISO(this.value).setLocale(this.locale):n.local();this._showCalendar=!1;this._bottomOfViewport=!1;this._isMobile=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._inputClick.bind(this)),window.addEventListener("click",this._windowClick.bind(this))}async firstUpdated(){await this._checkForBottomOfScreen(),await this._checkforMobile(),window.addEventListener("resize",this._checkForBottomOfScreen.bind(this)),window.addEventListener("scroll",this._checkForBottomOfScreen.bind(this)),window.addEventListener("resize",this._checkforMobile.bind(this)),window.addEventListener("scroll",this._checkforMobile.bind(this))}shouldUpdate(e){return e.has("value")&&(this.date=n.fromISO(this.value).setLocale(this.locale)),!0}focus(e){this._inputElement?this._inputElement.focus(e):super.focus(e)}async _checkForBottomOfScreen(){(visualViewport==null?void 0:visualViewport.height)-this.getBoundingClientRect().bottom<270?this._bottomOfViewport=!0:this._bottomOfViewport=!1}async _checkforMobile(){(window.matchMedia?window.matchMedia("screen and (min-width: 767px)").matches:window.innerWidth>=767)?this._isMobile=!1:this._isMobile=!0}_inputClick(e){let r=this.renderRoot.querySelector("#picker-container"),i=this.renderRoot.querySelector("#picker-dialog");(!e.composedPath()||!(r||i)||!(e.composedPath().includes(r)||e.composedPath().includes(i)))&&this._toggleCalendar()}_windowClick(e){let r=this.renderRoot.querySelector("#picker-dialog"),i=e.composedPath();i&&(!i.includes(this)||this._isMobile&&r&&i.findIndex(b=>b===r)===0)&&this._showCalendar&&this._toggleCalendar()}_toggleCalendar(){if(this._showCalendar){if(this._showCalendar=!1,this._isMobile){let e=this.renderRoot.querySelector("#picker-dialog");e&&e.close()}}else if(this._showCalendar=!0,this._isMobile){let e=this.renderRoot.querySelector("#picker-dialog");e&&e.showModal()}}_dateSelected(e){this.date=n.fromJSDate(e.detail.date),this.value=this.date.toISODate(),this.dispatchEvent(new CustomEvent("change",{detail:{date:this.date.toJSDate()}})),this._toggleCalendar()}static get styles(){return[super.styles,h`
        ...
        `}renderPicker(){return this._isMobile?a`
            ...
            </div>`:m}renderLabel(){return super.renderLabel(!0)}};o([u("#inputField")],t.prototype,"_inputElement",2),o([c({type:String,reflect:!0})],t.prototype,"locale",2),o([c({type:String,attribute:"min-date",reflect:!0})],t.prototype,"minDate",2),o([c({type:String,attribute:"max-date",reflect:!0})],t.prototype,"maxDate",2),o([l()],t.prototype,"date",2),o([l()],t.prototype,"_showCalendar",2),o([l()],t.prototype,"_bottomOfViewport",2),o([l()],t.prototype,"_isMobile",2),t=o([f("omni-date-picker")],t);export{t as a};
//# sourceMappingURL=chunk.C7DMCWO5.js.map
