import{a as b}from"./chunk.XMM72FEY.js";import{h}from"./chunk.ZO5UBYOG.js";import{a as m,b as i}from"./chunk.CHYIO324.js";import{a as s,b as t,d as c}from"./chunk.3GEUDTAZ.js";import{j as n,l,o as d}from"./chunk.2ZZQBHAA.js";l();d();var r=class extends h{connectedCallback(){super.connectedCallback(),this.tabIndex=this.disabled?-1:0,this.addEventListener("click",this._click)}focus(){var o,e;(e=(o=this.shadowRoot)==null?void 0:o.getElementById("content"))==null||e.focus()}_click(o){if(this.disabled)return o.stopImmediatePropagation();this._toggleChecked(o)}_keyDown(o){if(this.disabled)return o.stopImmediatePropagation();let e=(o.code||"").toUpperCase();if(e==="SPACE"||e==="ENTER")return this._toggleChecked(o),o.preventDefault()}_toggleChecked(o){let e=this.checked;this.checked=!e,this.dispatchEvent(new CustomEvent("value-change",{detail:{old:e,new:this.checked}})),o.stopPropagation()}static get styles(){return[super.styles,s`
        :host {
          outline: none;
        }
...
//# sourceMappingURL=chunk.JUETCE62.js.map
