import{a as m}from"../chunks-js/chunk.PJH7M65U.js";import{a as l}from"../chunks-js/chunk.G3QHRCKP.js";import{v as d}from"../chunks-js/chunk.6VUVFGIV.js";import"../chunks-js/chunk.P3AVSJ2D.js";import"../chunks-js/chunk.5NFB2EUQ.js";import"../chunks-js/chunk.U46MGZPC.js";import"../chunks-js/chunk.HA6SUF3B.js";import{c as a}from"../chunks-js/chunk.N6OKW4B2.js";import{d as n}from"../chunks-js/chunk.W54IKPJD.js";import"../chunks-js/chunk.2HYOR3YM.js";import"../chunks-js/chunk.CWNKFZ3E.js";import"../chunks-js/chunk.S2K25ADN.js";import{b as i}from"../chunks-js/chunk.F6MIXR4E.js";import{m as g,p as h}from"../chunks-js/chunk.BF43NN75.js";g();h();var q={title:"UI Components/Icon",component:"omni-icon"},F={render:t=>i`
    ...
    <g transform="translate(-2,-2)">
...
</svg>`,icon:void 0},play:async t=>{var s;let o=((s=a(t.canvasElement).getByTestId("test-icon").shadowRoot)==null?void 0:s.querySelector("slot")).assignedElements().find(c=>c.tagName.toLowerCase()==="svg");await n(o).toBeTruthy()}},V={render:t=>i`<omni-icon data-testid="test-icon" size="${t.size}">${l(t["[Default Slot]"])}</omni-icon>`,name:"SVG",description:"Set html/svg content to display as an icon.",args:{size:"large","[Default Slot]":d`
            <svg
                version="1.1"
                viewBox="0 0 16 16"
                xmlns="http://www.w3.org/2000/svg"
        ...
        `},play:async t=>{var s;let o=((s=a(t.canvasElement).getByTestId("test-icon").shadowRoot)==null?void 0:s.querySelector("slot")).assignedElements().find(c=>c.tagName.toLowerCase()==="svg");await n(o).toBeTruthy()}},k={render:t=>i`
    <!-- Icons loaded by content path instead of font-based or slotted content will not be able to be styled directly -->
    ...
    `,description:()=>i`Renders the icon by aligning both the inner height and width to the <strong>size</strong> attribute, creating a 1:1 aspect ratio.`,args:{size:"large",symmetrical:!0},play:async t=>{let e=a(t.canvasElement).getByTestId("test-icon").querySelector("svg");await n(e.clientWidth).toEqual(e.clientHeight)}};export{H as Asymmetrical,F as Interactive,k as Local_Source,y as Material,R as Remote_Source,V as SVG,D as Symmetrical,q as default};
