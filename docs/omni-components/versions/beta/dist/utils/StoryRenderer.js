import{a as ee}from"../chunks-js/chunk.EQXGZ5KJ.js";import"../chunks-js/chunk.OVX3SZRA.js";import"../chunks-js/chunk.LWOZ7YWS.js";import"../chunks-js/chunk.7GTL3UTF.js";import"../chunks-js/chunk.STJOQLHS.js";import"../chunks-js/chunk.5TKLJSC4.js";import"../chunks-js/chunk.XTHGQZD7.js";import{a as F}from"../chunks-js/chunk.K2UMXYHA.js";import"../chunks-js/chunk.P5BVWJU5.js";import"../chunks-js/chunk.E3RY574V.js";import"../chunks-js/chunk.XGCBNSF2.js";import"../chunks-js/chunk.V3AH72NQ.js";import{D as j,E as Q,a as z,b as U,c as G,d as K,e as X,s as Y,t as Z}from"../chunks-js/chunk.IFPMJPKV.js";import"../chunks-js/chunk.U46MGZPC.js";import"../chunks-js/chunk.P3AVSJ2D.js";import"../chunks-js/chunk.H2SV3XAM.js";import"../chunks-js/chunk.ZPV4YWBP.js";import"../chunks-js/chunk.6QCQBNRL.js";import"../chunks-js/chunk.B6SUKNHE.js";import"../chunks-js/chunk.2HYOR3YM.js";import"../chunks-js/chunk.CWNKFZ3E.js";import{a as W,b as V,c as w,d as H}from"../chunks-js/chunk.S2K25ADN.js";import{b as h,d as S,f as N,g as J}from"../chunks-js/chunk.F6MIXR4E.js";import{a as q,j as m,m as B,p as D}from"../chunks-js/chunk.BF43NN75.js";B();D();var c=class extends J{constructor(){super(...arguments);this._sourceTab="HTML"}async connectedCallback(){var t;if(super.connectedCallback(),this.controller=new ee(this,this.path),this.customCss=document.head.querySelector("#custom-css-vars"),!this.customCss){this.customCss=document.createElement("style"),this.customCss.id="custom-css-vars",document.head.appendChild(this.customCss);let s=sessionStorage.getItem(`custom-css-${this.tag}`);s&&(this.customCss.innerHTML=s)}this.modal||(this.modal=document.createElement("div"),document.body.appendChild(this.modal)),this.customElements=await Z();let e=X(this.tag,this.customElements);this.cssVariables=Object.keys(e).filter(s=>e[s].subcategory==="Component Variables").map(s=>{let o=e[s];return q({name:s},o)}),document.addEventListener("omni-docs-theme-change",s=>{var r;this.theme=(r=getComputedStyle(document.documentElement).getPropertyValue("--code-editor-theme"))==null?void 0:r.trim();let o=this.renderRoot.querySelectorAll("code-editor");o&&o.forEach(i=>{i.updateExtensions()})}),document.addEventListener(A,()=>{this.requestUpdate()}),this.theme=(t=getComputedStyle(document.documentElement).getPropertyValue("--code-editor-theme"))==null?void 0:t.trim()}disconnectedCallback(){this.modal&&(document.body.removeChild(this.modal),this.modal=null)}updated(e){var t;super.updated(e),(t=window.Prism)==null||t.highlightAll()}render(){var i,l,p,g,E,v,b,$,k,R,O,P,f,I,x,_,T,M,L;if(!((i=this.controller)!=null&&i.story))return h`<omni-loading-icon style="max-height: 64px;"></omni-loading-icon>`;N(h`
        ...
        `,this.modal),this.story=this.controller.story[this.key],this.story.originalArgs=(E=(p=this.story)==null?void 0:p.originalArgs)!=null?E:JSON.parse(JSON.stringify((g=this.story)==null?void 0:g.args));let e=this.story.render(this.story.args),t=(v=this.story.frameworkSources)==null?void 0:v.find(a=>a.framework==="HTML"),s=t!=null&&t.load?t.load(this.story.args):j(e),o=(b=this.story.frameworkSources)==null?void 0:b.find(a=>a.framework==="React"),r=o!=null&&o.load?o.load(this.story.args):"";return h`
        ...
        <div class="story">
            ...
            <div class="code-block html-code ${this._sourceTab==="HTML"?"":"no-display"}">
                ...
                @codemirror-source-change="${a=>{let n=a.detail.source;this._interactiveSrc=n,this.overrideInteractive=this._interactiveSrc!==this.originalInteractiveSrc&&this._interactiveSrc!==s,this.requestUpdate(),this.dispatchEvent(new CustomEvent(A,{bubbles:!0,composed:!0}))}}"
                ?read-only="${!0}">
                </code-editor>
            </div>
            ${r?h`
            ...
            <div class="two-part ${!((O=this.story)!=null&&O.play)&&((f=(P=this.story.frameworkSources)==null?void 0:P.find(a=>a.framework===this._sourceTab))==null?void 0:f.disableCodePen)&&!r?"no-display":""}">
            
                <div class="play-tests">
                    ${(I=this.story)!=null&&I.play?h`
...
`,"").replaceAll("\\n","").replaceAll("	","").replaceAll(" ","")}
                ...
                <div class="framework-toggles docs-omni-component">
                    ${!this.interactive&&r?h`
                            ...
                            `:S}
                    <div class="docs-omni-component codepen-gen-btn ${(M=(T=this.story.frameworkSources)==null?void 0:T.find(a=>a.framework===this._sourceTab))!=null&&M.disableCodePen?"no-display":""}" @click="${()=>this._generateCodePen(this._sourceTab,{React:r,HTML:s})}">
                        <omni-icon class="docs-omni-component" size="default">
    ...
    `}handleCustomThemeCSSVariableSearch(e){var r;let t=(r=e.target.value)!=null?r:"",o=document.querySelector(`[data-target=custom-css-table-${this.tag}]`).children;for(let i=0;i<o.length;i++){let l=o[i];l.innerText&&l.innerText.toLowerCase().includes(t.toLowerCase())?l.classList.remove("hidden"):l.classList.add("hidden")}}renderCssVariable(e){var s;let t=(s=this.customCss)==null?void 0:s.sheet;if(e.name){let o;if((t==null?void 0:t.cssRules.length)===0){let r=t.insertRule(":root {}");o=t.cssRules.item(r)}else for(let r=0;r<t.cssRules.length;r++){let i=t.cssRules[r];if(i.selectorText===":root"){o=i;break}}return o&&(e.value=o.style.getPropertyValue(`--${e.name}`)),e.control==="color"?h`
                    <omni-color-field
                        class="css-prop docs-omni-component"
                        .value="${F(e.value)}"
                        @input="${async r=>{var g;let p=((g=r.target.shadowRoot)==null?void 0:g.getElementById("inputField")).value;e.value=p,this._cssChanged(e)}}">
                    </omni-color-field>
                  `:h`
                    <omni-text-field
                        class="css-prop docs-omni-component"
                        .value="${F(e.value)}"
                        @input="${async r=>{var p;let l=((p=r.target.shadowRoot)==null?void 0:p.getElementById("inputField")).value;e.value=l,this._cssChanged(e)}}">
                    </omni-text-field>
                  `}return S}createRenderRoot(){return this}_sortCssVariables(e,t){var r;let s=(r=this.customCss)==null?void 0:r.sheet,o;if((s==null?void 0:s.cssRules.length)===0){let i=s.insertRule(":root {}");o=s.cssRules.item(i)}else for(let i=0;i<s.cssRules.length;i++){let l=s==null?void 0:s.cssRules[i];if(l.selectorText===":root"){o=l;break}}return o&&(e.value=o.style.getPropertyValue(`--${e.name}`),t.value=o.style.getPropertyValue(`--${t.name}`)),e.value?t.value?0:-1:t.value?1:0}_cssChanged(e){var r;let t=(r=this.customCss)==null?void 0:r.sheet,s;if((t==null?void 0:t.cssRules.length)===0){let i=t.insertRule(":root {}");s=t.cssRules.item(i)}else for(let i=0;i<t.cssRules.length;i++){let l=t==null?void 0:t.cssRules[i];if(l.selectorText===":root"){s=l;break}}e.value?s&&s.style.setProperty(`--${e.name}`,e.value):s&&s.style.removeProperty(`--${e.name}`);let o=s.cssText;sessionStorage.setItem(`custom-css-${this.tag}`,o)}_showComponentStyles(){this._showStylesDialog=!0}_checkCloseModal(e){var s;let t=(s=this.modal)==null?void 0:s.querySelector("div.modal-container");e.composedPath().includes(t)||(this._showStylesDialog=!1)}async _resetLivePropertyEditor(){var t,s;this.story.args=JSON.parse(JSON.stringify((t=this.story)==null?void 0:t.originalArgs)),this.overrideInteractive=!1;let e=(s=this.customCss)==null?void 0:s.sheet;for(let o=0;o<e.cssRules.length;o++)if((e==null?void 0:e.cssRules[o]).selectorText===":root"){e==null||e.deleteRule(o);break}sessionStorage.removeItem(`custom-css-${this.tag}`),this.requestUpdate(),this.dispatchEvent(new CustomEvent(A,{bubbles:!0,composed:!0})),await this.updateComplete,this.htmlCodeEditor&&await this.htmlCodeEditor.refresh(()=>{var o,r;return(r=(o=this.story.frameworkSources)==null?void 0:o.find(i=>i.framework==="HTML"))!=null&&r.load?this.story.frameworkSources.find(i=>i.framework==="HTML").load(this.story.args):j(this.story.render(this.story.args))}),this.reactCodeEditor&&await this.reactCodeEditor.refresh(()=>{var o,r;return(r=(o=this.story.frameworkSources)==null?void 0:o.find(i=>i.framework==="React"))!=null&&r.load?this.story.frameworkSources.find(i=>i.framework==="React").load(this.story.args):""}),this.propertyEditor&&this.propertyEditor.resetSlots()}async _generateCodePen(e,t){var x,_,T,M,L,a,n,C;let s=t[e],o=((_=(x=document.getElementById("header-version-indicator"))==null?void 0:x.innerText)!=null?_:"").toLowerCase(),i=this.customElements.modules.find(y=>{var u;return(u=y.exports)==null?void 0:u.find(d=>d.name===this.tag)}).path.split("/"),l=i[i.length-2],p=o&&o!=="latest"&&o!=="local"?["alpha","beta","next"].includes(o)?`esm-${o}`:`${o}-esm`:"esm",g="",E="";for(let y=0;y<document.styleSheets.length;y++){let u=document.styleSheets[y];try{if(u.cssRules)for(let d=0;d<u.cssRules.length;d++){let te=u.cssRules[d];E+=`
...
<html theme="${v!=null?v:"light"}">
    <body style="
        ...
        padding: 24px;
    ">
        ${s.replaceAll("@capitec/omni-components",`https://cdn.jsdelivr.net/npm/@capitec/omni-components@${p}`).replace(new RegExp(`(https://cdn.jsdelivr.net/npm/@capitec/omni-components@${p}/)([^/"'\`]+)`,"g"),"$1dist/$2/index.js")}
    </body>
</html>`,b=`import 'https://cdn.jsdelivr.net/npm/@capitec/omni-components@${p}/dist/omni-components.js';`;break;case"React":g=`
<html theme="${v!=null?v:"light"}">
    <body style="
        display: flex;
        justify-content: center;
...
${s.replaceAll("@capitec/omni-components-react",`https://cdn.jsdelivr.net/npm/@capitec/omni-components-react@${p}`).replace(new RegExp(`https://cdn.jsdelivr.net/npm/@capitec/omni-components-react@${p}/([^/"'\`]+)`,"g"),"$&/index.js")} 

const el = document.querySelector("#root");
ReactDOM.render(<App/>, el);`,$="babel",k="https://cdnjs.cloudflare.com/ajax/libs/react/16.7.0/umd/react.production.min.js;https://cdnjs.cloudflare.com/ajax/libs/react-dom/16.7.0/umd/react-dom.production.min.js";break}let R={title:`${(L=(M=this.key)!=null?M:(T=this.story)==null?void 0:T.name)!=null?L:"Generated CodePen"} - ${e}`,description:((a=this.story)==null?void 0:a.description)&&typeof((n=this.story)==null?void 0:n.description)=="function"?this.story.description():(C=this.story)==null?void 0:C.description,private:!1,tags:[e,"Omni Components","web components","custom elements"],editors:"1011",layout:"top",html:g,html_pre_processor:"none",css:E,css_pre_processor:"none",css_starter:"neither",css_prefix:"neither",js:b,js_pre_processor:$,head:`<link rel="stylesheet preload" href="https://fonts.googleapis.com/css?family=Hind Vadodara" as="style">
        ...
        </form>`,f=document.createElement("div");f.innerHTML=P,f.style.display="none",document.body.appendChild(f),f.querySelector(".code-submit").click(),document.body.removeChild(f)}async _play(e,t){var s,o,r;try{if(!e.play)return;this._isBusyPlaying=!0;let i=this._createStoryContext(e,t);await e.play(i),this.querySelector(t+"-result.success").style.display="flex",this.querySelector(t+"-result.failure").style.display="none"}catch(i){this.querySelector(t+"-result.failure").style.display="flex",this.querySelector(t+"-result.success").style.display="none",this._playError=(r=(o=(s=i==null?void 0:i.matcherResult)==null?void 0:s.message)!=null?o:i==null?void 0:i.message)==null?void 0:r.toString().replace(/\u001b[^m]*?m/g,"").replace(/\n \u001b[^m]*?m/g,"").replace(/\u001b[^m]*?m\n/g,"").replace(/\n\u001b[^m]*?m/g,"")}finally{this._isBusyPlaying=!1}}_createStoryContext(e,t){return{story:e,args:e.args,canvasElement:this.querySelector(t)}}_currentCodeTheme(){var e;return((e=this.theme)==null?void 0:e.toLowerCase())==="dark"?G:K}};m([V({type:String,reflect:!0})],c.prototype,"path",2),m([V({type:String,reflect:!0})],c.prototype,"tag",2),m([V({type:String,reflect:!0})],c.prototype,"key",2),m([V({type:Boolean,reflect:!0})],c.prototype,"interactive",2),m([w()],c.prototype,"_interactiveSrc",2),m([w()],c.prototype,"_isBusyPlaying",2),m([w()],c.prototype,"_playError",2),m([w()],c.prototype,"_showStylesDialog",2),m([w()],c.prototype,"_sourceTab",2),m([H(".html-source-code")],c.prototype,"htmlCodeEditor",2),m([H(".react-source-code")],c.prototype,"reactCodeEditor",2),m([H(".live-props")],c.prototype,"propertyEditor",2),c=m([W("story-renderer")],c);var A="story-renderer-interactive-update";export{c as StoryRenderer};
