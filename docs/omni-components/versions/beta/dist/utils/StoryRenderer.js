import"../chunks-js/chunk.E7RQHMJI.js";import{a as te}from"../chunks-js/chunk.EQXGZ5KJ.js";import"../chunks-js/chunk.LWOZ7YWS.js";import"../chunks-js/chunk.7GTL3UTF.js";import"../chunks-js/chunk.STJOQLHS.js";import"../chunks-js/chunk.5TKLJSC4.js";import"../chunks-js/chunk.XTHGQZD7.js";import{a as F}from"../chunks-js/chunk.K2UMXYHA.js";import"../chunks-js/chunk.P5BVWJU5.js";import"../chunks-js/chunk.E3RY574V.js";import"../chunks-js/chunk.XGCBNSF2.js";import"../chunks-js/chunk.V3AH72NQ.js";import{a as z}from"../chunks-js/chunk.G3QHRCKP.js";import{D as j,E as ee,a as U,b as G,c as K,d as W,e as Y,s as Z,t as Q}from"../chunks-js/chunk.BM33DA64.js";import"../chunks-js/chunk.P3AVSJ2D.js";import"../chunks-js/chunk.H2SV3XAM.js";import"../chunks-js/chunk.U46MGZPC.js";import"../chunks-js/chunk.ZPV4YWBP.js";import"../chunks-js/chunk.PJH7M65U.js";import"../chunks-js/chunk.B6SUKNHE.js";import"../chunks-js/chunk.2HYOR3YM.js";import"../chunks-js/chunk.CWNKFZ3E.js";import{a as X,b as V,c as w,d as H}from"../chunks-js/chunk.S2K25ADN.js";import{b as h,d as S,f as N,g as J}from"../chunks-js/chunk.F6MIXR4E.js";import{a as q,j as m,m as B,p as D}from"../chunks-js/chunk.BF43NN75.js";B();D();var c=class extends J{constructor(){super(...arguments);this._sourceTab="HTML"}async connectedCallback(){var s;if(super.connectedCallback(),this.controller=new te(this,this.path),this.customCss=document.head.querySelector("#custom-css-vars"),!this.customCss){this.customCss=document.createElement("style"),this.customCss.id="custom-css-vars",document.head.appendChild(this.customCss);let t=sessionStorage.getItem(`custom-css-${this.tag}`);t&&(this.customCss.innerHTML=t)}this.modal||(this.modal=document.createElement("div"),document.body.appendChild(this.modal)),this.customElements=await Q();let e=Y(this.tag,this.customElements);this.cssVariables=Object.keys(e).filter(t=>e[t].subcategory==="Component Variables").map(t=>{let o=e[t];return q({name:t},o)}),document.addEventListener("omni-docs-theme-change",t=>{var r;this.theme=(r=getComputedStyle(document.documentElement).getPropertyValue("--code-editor-theme"))==null?void 0:r.trim();let o=this.renderRoot.querySelectorAll("code-editor");o&&o.forEach(i=>{i.updateExtensions()})}),document.addEventListener(O,()=>{this.requestUpdate()}),this.theme=(s=getComputedStyle(document.documentElement).getPropertyValue("--code-editor-theme"))==null?void 0:s.trim()}disconnectedCallback(){this.modal&&(document.body.removeChild(this.modal),this.modal=null)}render(){var i,l,u,g,E,v,b,k,$,R,I,P,f,A,x,_,T,L,M;if(!((i=this.controller)!=null&&i.story))return h`<omni-loading-icon style="max-height: 64px;"></omni-loading-icon>`;N(h`
        ...
        `,this.modal),this.story=this.controller.story[this.key],this.story.originalArgs=(E=(u=this.story)==null?void 0:u.originalArgs)!=null?E:JSON.parse(JSON.stringify((g=this.story)==null?void 0:g.args));let e=this.story.render(this.story.args),s=(v=this.story.frameworkSources)==null?void 0:v.find(a=>a.framework==="HTML"),t=s!=null&&s.load?s.load(this.story.args):j(e),o=(b=this.story.frameworkSources)==null?void 0:b.find(a=>a.framework==="React"),r=o!=null&&o.load?o.load(this.story.args):"";return h`
        <div class="story-description">
            ${((k=this.story)==null?void 0:k.description)&&typeof(($=this.story)==null?void 0:$.description)=="function"?this.story.description():(R=this.story)==null?void 0:R.description}
        </div>
        <div class="story">
            <div class="preview">
                <div class="item">
            ...
            <div class="two-part ${!((I=this.story)!=null&&I.play)&&((f=(P=this.story.frameworkSources)==null?void 0:P.find(a=>a.framework===this._sourceTab))==null?void 0:f.disableCodePen)&&!r?"no-display":""}">
            
                <div class="play-tests">
                    ${(A=this.story)!=null&&A.play?h`
...
</html>`,b=`import 'https://cdn.jsdelivr.net/npm/@capitec/omni-components@${u}/dist/omni-components.js';`;break;case"React":g=`
<html theme="${v!=null?v:"light"}">
    <body style="
        display: flex;
        justify-content: center;
