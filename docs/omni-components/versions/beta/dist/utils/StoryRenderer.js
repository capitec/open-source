...
`,"").replaceAll("\\n","").replaceAll("	","").replaceAll(" ","")}
                ...
                <div class="framework-toggles docs-omni-component">                    
                    <div class="docs-omni-component codepen-gen-btn ${((G=(K=this.story.frameworkSources)==null?void 0:K.find(i=>i.framework===s))==null?void 0:G.disableCodePen)||this.noInteractiveCodePen.includes(s)&&this.interactive?"no-display":""}" @click="${()=>{var i;return this._generateCodePen((i=window.localStorage.getItem(w))!=null?i:"HTML",c)}}">
