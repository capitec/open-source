...
test(`Alert - Visual and Behaviour`, async ({ page }) => {
    await withCoverage(page, async () => {
        ...
        const alertActionClickResponse = createWaitHandle();
...
test(`Alert - Show Behaviour`, async ({ page }) => {
    await withCoverage(page, async () => {
        ...
        await page.evaluate(async () => {
            const AlertType = (await customElements.whenDefined('omni-alert'));
            AlertType.show({
                id: 'test-show-alert',
                status: 'success',
                message: 'Success!',
